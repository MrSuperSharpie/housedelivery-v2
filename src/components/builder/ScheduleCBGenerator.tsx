  ...
  win.document.write(`
    ...
    <body>
      ...
      <div class="section">
        ...
        <div class="section-body">
          ...
          <div class="field-row">
            ...
            <div class="field-value">On-site inspection per SiteLine dispatch</div>
          </div>
        </div>
      </div>
      ...
      <div class="legal-note">
        ...
        <br><br>
        Generated by SiteLine Technologies Inc. — siteline.ca · Vancouver, BC
      </div>

      <div class="footer">
        <div>
          <div style="margin-bottom:4px;"><strong>SiteLine Technologies Inc.</strong></div>
