...
export function CommandHeader({ company, onPostRequest, onOpenVault }: CommandHeaderProps) {
  return (
    <div className="relative overflow-hidden border-b border-rim/70 bg-gradient-to-b from-panel to-surface bg-dot bg-dot-sm">
      {/* Depth: soft brass glow top-right + top hairline, echoing the homepage hero */}
      <div className="pointer-events-none absolute -top-28 right-[-8rem] h-80 w-80 rounded-full bg-[#C6A15B]/10 blur-3xl" />
      <div className="pointer-events-none absolute inset-0 bg-gradient-to-r from-[#C6A15B]/[0.06] via-transparent to-transparent" />
        ...
        <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          ...
          <div className="flex shrink-0 flex-wrap items-center gap-2.5">
            <button
              ...
              className="group btn-gold inline-flex items-center gap-2.5 rounded-2xl px-5 py-3.5 text-sm font-bold transition-all glow-gold-sm"
            >
