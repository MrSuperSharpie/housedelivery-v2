...
const SEMANTIC_MAPPINGS: Array<{
  ...
  },
  {
    ...
    tsStageNumber: 7,
    dbStageSlugs: ['roof_deck_sheathing', 'building_envelope'],
    confidence: 'medium',
    riskLevel: 'high',
    recommendation: 'defer',
    notes: ['DB splits roof deck/sheathing and envelope into separate stages.'],
  },
  {
    id: 'fire-life-safety',
    domain: 'Fire, life safety, egress, alarms, accessibility, and guards',
    tsStageNumber: 8,
    dbStageSlugs: ['fire_suppression_rough_in', 'life_safety_systems'],
    confidence: 'low',
    riskLevel: 'high',
    recommendation: 'defer',
    notes: ['DB separates suppression rough-in and final life-safety systems; TS groups broader life-safety checks.'],
  },
  {
    id: 'plumbing',
  ...
  },
  {
    ...
    tsStageNumber: 10,
    dbStageSlugs: ['electrical_rough_in'],
    confidence: 'medium',
    riskLevel: 'high',
    recommendation: 'defer',
    notes: ['TS S10 maps to DB S08; avoid stage-number mapping.'],
  },
  {
    id: 'mechanical-gas',
    domain: 'Mechanical, HVAC, gas, equipment, venting, and testing',
    tsStageNumber: 11,
    dbStageSlugs: ['mechanical_rough_in'],
    confidence: 'medium',
    riskLevel: 'high',
    recommendation: 'defer',
    notes: ['TS S11 maps to DB S06; DB legal references may be useful later.'],
  },
  {
    id: 'insulation-energy',
    domain: 'Insulation, air/vapour barrier, airtightness, and energy compliance',
    tsStageNumber: 12,
    dbStageSlugs: ['insulation_vapor_barrier'],
    confidence: 'high',
    riskLevel: 'medium',
    recommendation: 'enrich_ts_from_db_metadata',
    notes: ['Good legal-reference enrichment candidate after a safer pilot. TS S12 maps to DB S11.'],
  },
  {
    id: 'interior',
    domain: 'Interior completion, drywall, finishes, backing, and trim',
    tsStageNumber: 13,
    dbStageSlugs: ['drywall_interior_finish'],
    confidence: 'medium',
    riskLevel: 'high',
    recommendation: 'defer',
    notes: ['TS interior items are broader and less fire-rated-assembly specific than DB S12.'],
  },
  {
    id: 'final-site',
    domain: 'Final site, grading, drainage, hardscaping, and environment',
    tsStageNumber: 14,
    dbStageSlugs: ['final_site_grading'],
    confidence: 'high',
    riskLevel: 'medium',
    recommendation: 'feature_flag_pilot_candidate',
  ...
  },
  {
    ...
    tsStageNumber: 15,
    dbStageSlugs: ['final_occupancy_permit'],
    confidence: 'high',
    riskLevel: 'do_not_touch',
    recommendation: 'defer',
