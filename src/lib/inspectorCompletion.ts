...
const STRUCTURAL_STAGE_10_CONTAINERS: StructuredStageItemDefinition[] = [
  {
    code: 'S10-01',
    label: 'Electrical Permit and Service Readiness',
    uiSchema: 'field_view',
    purpose: 'Confirm the electrical permit is issued, the service and distribution backbone is installed safely, and the project is ready to advance rough wiring before concealment.',
    viewDetails: 'Validate the electrical permit scope, service entrance, meter base, main distribution panel, grounding, bonding, and load calculation documentation where required. This container establishes the electrical service foundation before downstream rough-in advances.',
    stopIf: [
      'Panel bonding or grounding is missing or service entrance is unprotected before rough wiring advances.',
      'Electrical permit is not issued or scope does not match installed work.',
    ],
    fieldChecklist: [
      'Electrical permit issued and scope confirmed to match installed work? (Permit document or AHJ portal reference required)',
      'Service entrance, meter base, and main distribution panel installed at correct location per permit? (Camera Evidence Required)',
      'Panel accessible, labelled, and clear of obstruction where applicable?',
      'Service capacity and load calculation documentation available where required by applicable code or permit path?',
      'Main disconnect and over-current protection present and correctly sized where observable?',
      'Grounding electrode system and bonding complete and visible for review? (Camera Evidence Required)',
      'Utility coordination complete or pending where required by applicable authority?',
    ],
    notesGuidance: 'Record service equipment, panel condition, grounding and bonding details, permit scope confirmation, and any protection or documentation deficiency affecting electrical readiness.',
    whatToCheck: [
      'Electrical permit is issued and reflects the scope of installed work.',
      'Service entrance, meter base, and panel are at the correct location per permit.',
      'Panel is accessible, labelled, and clear of obstruction where applicable.',
      'Load calculation documentation is present where required.',
      'Grounding and bonding are complete and visible for review.',
    ],
    passWhen: [
      'Electrical permit is issued and scope aligns with installed work.',
      'Service and distribution backbone is installed and reviewable for the presented stage.',
      'Grounding and bonding support safe progression of the electrical scope.',
    ],
    failWhen: [
      'Electrical permit is not issued or installed work is materially outside the permitted scope.',
      'Service equipment is materially incomplete, unprotected, or not installed safely.',
      'Required grounding or bonding is missing, incomplete, or visibly deficient.',
    ],
    pendingWhen: [
      'Service installation is near readiness but awaiting final grounding, bonding, or protection work.',
      'Load calculation documentation is expected shortly.',
    ],
    requiredEvidence: [
      'Inspector-captured field photos showing service equipment, panel condition, and grounding and bonding components.',
      'Permit confirmation reference or AHJ portal record where available.',
    ],
    optionalEvidence: [
      'Supplemental panel-detail photos.',
      'Load calculation documentation where provided by contractor.',
    ...
    responsibleParty: 'Inspector',
    documentUploadRequired: true,
    ahjNotes: 'Capture local service-equipment, grounding, bonding, load calculation, or permit scope requirements affecting electrical rough-in acceptance.',
    dependencies: ['S08-03'],
    codeReferences: [
      {
        label: 'BC Safety Standards Act — Technical Safety BC electrical permit and inspection jurisdiction',
        legalReference: 'BC Safety Standards Act, SBC 2003, c. 39',
        sourceTitle: 'Technical Safety BC',
        sourceUrl: 'https://www.technicalsafetybc.ca/electrical',
      },
      {
        label: 'BC Building Code 2024 — Electrical service and facilities',
        legalReference: 'BCBC 2024 Division B, Part 9',
        sourceTitle: 'British Columbia Building Code 2024',
        sourceUrl: 'https://www.bccodes.ca/bc-building-code.html',
      },
      {
        label: 'Vancouver Building By-law 2025 — Electrical permit and service requirements',
        legalReference: 'VBBL 2025, Division B',
        sourceTitle: 'Vancouver Building By-law 2025',
        isVbblOnly: true,
      },
    ],
  ...
  {
    code: 'S10-02',
    label: 'Branch Circuit Rough-In',
    uiSchema: 'field_view',
    purpose: 'Confirm branch-circuit rough wiring and device rough-in are installed, supported, protected, and ready for enclosure.',
    viewDetails: 'Validate branch electrical rough wiring including cable routing, support at required intervals, protection with nail plates at vulnerable framing locations, outlet and switch box mounting, wet-area and specialty circuit rough-ins, and EV charger or conduit provisions where the permit scope requires them.',
    stopIf: [
      'Rough wiring is unsupported, unprotected at vulnerable framing points, or device rough-in is materially incomplete before concealment.',
    ],
    fieldChecklist: [
      'Branch wiring pulled, supported at required intervals, and protected with nail plates at vulnerable framing locations? (Camera or Note Evidence Required)',
      'Outlet boxes and switch boxes securely mounted at correct heights and accessible for device installation?',
      'Bathroom, kitchen, garage, laundry, and mechanical-space circuits roughed in where permit scope requires?',
      'AFCI and GFCI provisions roughed in where required by applicable code and permit path?',
      'Exterior weatherproof device boxes and covers roughed in where applicable?',
      'EV charger conduit or rough-in installed where required by permit or approved plan?',
      'No wiring runs left exposed to mechanical damage without protection where applicable?',
    ],
    notesGuidance: 'Record cable support, protection, box placement, wet-area rough-in completeness, AFCI/GFCI coordination, EV rough-in status, and any device rough-in deficiency affecting readiness for concealment.',
    whatToCheck: [
      ...
      'Wet-area circuits are roughed in where the permit scope requires them.',
      'AFCI and GFCI provisions are roughed in where required by the applicable code or permit path.',
      'EV charger conduit or rough-in is installed where required by permit or plan.',
    ...
    passWhen: [
      ...
      'Observed support, protection, wet-area coverage, and mounting conditions support safe concealment.',
    ],
    failWhen: [
      ...
      'Required wet-area circuit rough-in is absent where applicable.',
      'Required AFCI or GFCI provisions are missing where the applicable code or permit path requires them.',
    ],
    pendingWhen: [
    ...
    optionalEvidence: [
      ...
      'EV charger specification or plan reference where applicable.',
    ],
    evidenceMode: 'required_upload',
    permitType: 'electrical',
    responsibleParty: 'Inspector',
    documentUploadRequired: true,
    ahjNotes: 'Capture local rough-wiring, box placement, AFCI/GFCI, EV provision, or protection requirements that must be satisfied before enclosure.',
    dependencies: ['S10-01'],
    codeReferences: [
      {
        label: 'BC Safety Standards Act — Technical Safety BC branch circuit rough-in requirements',
        legalReference: 'BC Safety Standards Act, SBC 2003, c. 39',
        sourceTitle: 'Technical Safety BC',
        sourceUrl: 'https://www.technicalsafetybc.ca/electrical',
      },
      {
        label: 'BC Building Code 2024 — Branch circuits, GFCI, and electrical rough-in',
        legalReference: 'BCBC 2024 Division B, Part 9',
        sourceTitle: 'British Columbia Building Code 2024',
        sourceUrl: 'https://www.bccodes.ca/bc-building-code.html',
      },
      {
        label: 'Vancouver Building By-law 2025 — Branch circuit and EV readiness requirements where applicable',
        legalReference: 'VBBL 2025, Division B',
        sourceTitle: 'Vancouver Building By-law 2025',
        isVbblOnly: true,
      },
  ...
  {
    code: 'S10-03',
    label: 'Life Safety, Specialty Circuits, and Pre-Test Readiness',
    uiSchema: 'field_view',
    purpose: 'Confirm life-safety circuit coordination, specialty circuit provisions, and pre-test readiness are in place before concealment.',
    viewDetails: 'Ensure smoke alarm and CO detector interconnect wiring is installed at required locations, telecom and conduit provisions are present where the project scope requires them, and specialty circuits such as solar, battery storage, or backup-power rough-in are installed where applicable. This container confirms no life-safety or specialty circuit gap remains before concealment.',
    stopIf: [
      'Life-safety interconnect wiring is absent or materially incomplete where required for the reviewed scope.',
    ],
    fieldChecklist: [
      'Smoke alarm interconnect wiring installed at required locations where applicable? (Camera or Note Evidence Required)',
      'CO detector interconnect wiring installed in required proximity to fuel-fired appliance zones where applicable?',
      'Telecom, structured wiring, and conduit provisions installed where project scope requires?',
      'Solar, battery storage, generator, or backup-power rough-in installed where required by permit or approved plan?',
      'EV charging branch circuit confirmed if roughed in at prior stage?',
      'No life-safety or specialty circuit gap remains before concealment?',
    ],
    notesGuidance: 'Record interconnect wiring, CO alarm proximity to fuel-fired zones, telecom pathway conditions, and specialty circuit rough-in status. Note any omission affecting life-safety coordination or future serviceability.',
    whatToCheck: [
      'Smoke alarm interconnect wiring is installed at required locations where the permit scope requires it.',
      'CO detector wiring is in required proximity to fuel-fired appliance zones where applicable.',
      'Telecom and conduit provisions are installed where the project requires them.',
      'Specialty circuit rough-in provisions are in place where required by permit or plan.',
      'No critical life-safety or low-voltage pathway omission remains before concealment.',
    ],
    passWhen: [
      'Life-safety interconnects and applicable telecom provisions are present and coordinated for the presented stage.',
      'The electrical rough-in is ready to proceed without an unresolved low-voltage or life-safety gap.',
    ],
    failWhen: [
      'Smoke alarm or CO detector interconnect wiring is missing or materially incomplete where required.',
      'Required telecom or conduit provisions are absent for the reviewed scope.',
      'Specialty circuit rough-in is absent where required by permit or approved plan.',
    ],
    pendingWhen: [
      'Low-voltage or life-safety provisions are partially installed and require follow-up before concealment.',
      'Specialty circuit scope applicability is pending AHJ or plan confirmation.',
    ],
    requiredEvidence: [
      'Inspector-captured field notes or photos documenting detector interconnect, telecom pathway readiness, and specialty circuit rough-in status where needed to support the decision.',
    ],
    optionalEvidence: [
    ...
    responsibleParty: 'Inspector',
    documentUploadRequired: true,
    ahjNotes: 'Capture local life-safety wiring, CO alarm placement, interconnect, telecom, conduit, or specialty circuit requirements that must be satisfied before enclosure.',
    dependencies: ['S10-02'],
    codeReferences: [
      {
        label: 'BC Building Code 2024 — Smoke alarms, CO alarms, and life-safety electrical provisions',
        legalReference: 'BCBC 2024 Division B, Part 9',
        sourceTitle: 'British Columbia Building Code 2024',
        sourceUrl: 'https://www.bccodes.ca/bc-building-code.html',
      },
      {
        label: 'BC Safety Standards Act — Technical Safety BC low-voltage and specialty circuit requirements',
        legalReference: 'BC Safety Standards Act, SBC 2003, c. 39',
        sourceTitle: 'Technical Safety BC',
        sourceUrl: 'https://www.technicalsafetybc.ca/electrical',
      },
      {
        label: 'Vancouver Building By-law 2025 — Life-safety wiring and specialty circuit requirements where applicable',
        legalReference: 'VBBL 2025, Division B',
        sourceTitle: 'Vancouver Building By-law 2025',
        isVbblOnly: true,
      },
  ...
  {
    code: 'S10-04',
    label: 'Electrical Inspection and Documentation Closeout',
    uiSchema: 'field_view',
    purpose: 'Confirm the electrical rough-in has cleared the required Technical Safety BC inspection gate and documentation package before concealment or energization proceeds.',
    viewDetails: 'Validate the administrative closeout of the electrical rough-in scope, including Technical Safety BC inspection status, electrical inspection certificate or declaration on file, and any correction items addressed. This container is the formal gate between installed electrical work and accepted work before the envelope is closed.',
    stopIf: [
      'Technical Safety BC electrical rough-in inspection has not passed or been documented, and concealment is imminent.',
    ],
    fieldChecklist: [
      'Technical Safety BC electrical rough-in inspection passed or documented inspection status confirmed where applicable? (Certificate or declaration reference required)',
      'Electrical inspection certificate or declaration on file where required?',
      'Correction items from Technical Safety BC or AHJ identified and addressed where applicable?',
      'Permit status reflects completed rough electrical inspection where applicable?',
      'Evidence package complete and sufficient to support concealment authorization?',
    ],
    notesGuidance: 'Record Technical Safety BC inspection status, certificate or declaration reference, any outstanding correction items, and permit record state. Note any administrative hold that would block concealment.',
    whatToCheck: [
      'Technical Safety BC electrical rough-in inspection has passed or is clearly documented for the presented scope.',
      'Electrical inspection certificate or declaration is on file where the applicable permit path requires it.',
      'Correction items from Technical Safety BC or the AHJ have been addressed and documented.',
      'No administrative hold remains that would block safe concealment.',
    ],
    passWhen: [
      'Technical Safety BC electrical inspection gate is documented as cleared for the presented scope.',
      'No unresolved correction, certificate, or declaration item remains before concealment.',
    ],
    failWhen: [
      'Technical Safety BC electrical rough-in inspection has not passed where required.',
      'Inspection certificate or declaration is missing where required by the applicable permit path.',
      'Outstanding correction items from Technical Safety BC or AHJ are unresolved.',
    ],
    pendingWhen: [
      'Technical Safety BC inspection is scheduled but not yet completed.',
      'Supporting certificate or declaration records are expected and may resolve the documentation gap.',
    ],
    requiredEvidence: [
      'Technical Safety BC inspection certificate, declaration reference, or documented inspection status confirming electrical rough-in closeout.',
    ],
    optionalEvidence: [
      'Supplemental notes documenting inspector feedback or outstanding conditions.',
      'Correction-item resolution records.',
      'Permit record screenshot or AHJ portal reference.',
    ],
    evidenceMode: 'required_upload',
    permitType: 'electrical',
    responsibleParty: 'Inspector',
    documentUploadRequired: true,
    ahjNotes: 'Capture local electrical inspection, Technical Safety BC certificate, or AHJ approval conditions that must be satisfied before concealment or energization.',
    dependencies: ['S10-03'],
    codeReferences: [
      {
        label: 'BC Safety Standards Act — Technical Safety BC electrical inspection and certificate requirements',
        legalReference: 'BC Safety Standards Act, SBC 2003, c. 39',
        sourceTitle: 'Technical Safety BC',
        sourceUrl: 'https://www.technicalsafetybc.ca/electrical',
      },
      {
        label: 'BC Building Code 2024 — Inspection requirements before concealment of electrical rough-in',
        legalReference: 'BCBC 2024 Division C, Part 2',
        sourceTitle: 'British Columbia Building Code 2024',
        sourceUrl: 'https://www.bccodes.ca/bc-building-code.html',
      },
      {
        label: 'Vancouver Building By-law 2025 — Electrical rough-in inspection and concealment authorization',
        legalReference: 'VBBL 2025, Division C',
        sourceTitle: 'Vancouver Building By-law 2025',
        isVbblOnly: true,
      },
    ],
...
const STRUCTURAL_STAGE_11_CONTAINERS: StructuredStageItemDefinition[] = [
  {
    code: 'S11-01',
    label: 'Mechanical Permit and Equipment Rough-In',
    uiSchema: 'field_view',
    purpose: 'Confirm the mechanical permit is issued, core heating, cooling, and ventilation equipment is installed at correct locations with required clearances, and the project is ready to advance the mechanical scope before concealment.',
    viewDetails: 'Validate the mechanical permit scope, heat-load calculation documentation where required, equipment installation with required clearances, seismic restraint where applicable, ductwork support, and refrigerant line rough-ins. This container establishes the mechanical design and equipment foundation before gas and ventilation rough-in advances.',
    stopIf: [
      'Mechanical permit is not issued or scope does not match installed equipment and systems.',
      'Heat-load calculation documentation is absent where required and equipment selection cannot be confirmed.',
    ],
    fieldChecklist: [
      'Mechanical permit issued and scope confirmed to match installed equipment and systems? (Permit document or AHJ portal reference required)',
      'Heat-load calculation documentation present and supports installed equipment selection where required by applicable code or permit path?',
      'Heating, cooling, and ventilation equipment installed at correct locations with required clearances? (Camera Evidence Required)',
      'Seismic anchoring or equipment restraint installed where required by applicable code or AHJ?',
      'Refrigerant line sets and condensate provisions roughed in where applicable?',
      'Ductwork runs installed, supported at required intervals, and not yet concealed where inspection is required?',
      'Equipment labels visible and equipment access maintained where applicable?',
    ],
    notesGuidance: 'Record equipment installation, heat-load documentation basis, clearances, seismic restraint status, ductwork support conditions, and any equipment, design-basis, or permit scope deficiency affecting mechanical rough-in readiness.',
    whatToCheck: [
      'Mechanical permit is issued and reflects the scope of installed equipment and systems.',
      'Heat-load calculation documentation is present where required by the applicable permit path.',
      'Heating, cooling, and ventilation equipment is installed at correct locations with required clearances.',
      'Seismic anchoring or restraint provisions are in place where required.',
      'Ductwork is installed, supported, and not concealed where inspection is required.',
      'Equipment labels are visible and access is maintained where applicable.',
    ],
    passWhen: [
      'Mechanical permit is issued and scope aligns with installed equipment and systems.',
      'Core mechanical equipment rough-in is complete enough for the presented stage.',
      'Observed equipment, ductwork, and design-basis conditions support safe progression.',
    ],
    failWhen: [
      'Mechanical permit is not issued or installed work is materially outside the permitted scope.',
      'Heat-load calculation documentation is missing or clearly inadequate for the installed equipment where required.',
      'Required equipment is missing, materially mislocated, or installed without required clearances.',
      'Seismic restraint is absent where required by applicable code or AHJ.',
    ],
    pendingWhen: [
      'The rough mechanical package is substantially installed but awaiting final equipment, ductwork, or seismic restraint completion.',
      'A design or equipment clarification is expected before a final decision can be made.',
    ],
    requiredEvidence: [
      'Inspector-captured field photos showing equipment installation, clearances, ductwork, and seismic restraint conditions.',
      'Permit confirmation reference or AHJ portal record where available.',
    ],
    optionalEvidence: [
      'Heat-load calculation records where provided by contractor.',
    ...
    responsibleParty: 'Inspector',
    documentUploadRequired: true,
    ahjNotes: 'Capture local mechanical permit scope, heat-load calculation, equipment clearance, seismic restraint, or ductwork requirements that must be satisfied before concealment or activation.',
    dependencies: ['S08-03'],
    codeReferences: [
      {
        label: 'BC Building Code 2024 — Heating, ventilating, and air-conditioning equipment requirements',
        legalReference: 'BCBC 2024 Division B, Part 6',
        sourceTitle: 'British Columbia Building Code 2024',
        sourceUrl: 'https://www.bccodes.ca/bc-building-code.html',
      },
      {
        label: 'BC Safety Standards Act — Technical Safety BC mechanical permit and equipment jurisdiction',
        legalReference: 'BC Safety Standards Act, SBC 2003, c. 39',
        sourceTitle: 'Technical Safety BC',
        sourceUrl: 'https://www.technicalsafetybc.ca/gas',
      },
      {
        label: 'Vancouver Building By-law 2025 — Mechanical permit and equipment requirements where applicable',
        legalReference: 'VBBL 2025, Division B',
        sourceTitle: 'Vancouver Building By-law 2025',
        isVbblOnly: true,
      },
  ...
  {
    code: 'S11-02',
    label: 'Gas Piping, Venting, and Combustion',
    uiSchema: 'field_view',
    purpose: 'Confirm gas piping, appliance venting, and combustion air provisions are installed, protected, and supported by required documentation before concealment.',
    viewDetails: 'Validate gas piping routing, support, and protection; gas shutoffs at appliance locations; contractor-documented pressure test evidence; appliance venting material, slope, and exterior termination; and combustion air provisions where fuel-fired appliances are installed. This container confirms no gas piping is concealed before required inspection or test status is documented.',
    stopIf: [
      'Gas pressure test documentation is absent or failed and concealment of gas piping is imminent.',
      'Gas piping is being concealed before Technical Safety BC or AHJ inspection clearance is documented.',
    ],
    fieldChecklist: [
      'Gas piping routed, supported, and protected at vulnerable locations per permit? (Camera Evidence Required)',
      'Gas shutoffs present at each appliance location where required?',
      'Gas pressure test performed by qualified contractor and documentation on file where required? (Contractor pressure test record required)',
      'Appliance venting installed with correct material, slope, clearances, and exterior termination where applicable?',
      'Combustion air provisions complete and unobstructed where fuel-fired appliances are installed?',
      'Gas piping protected from corrosion and mechanical damage where applicable?',
      'No gas piping concealed without documented inspection or pressure test status where applicable?',
    ],
    notesGuidance: 'Record gas piping routing, support, protection, shutoff locations, pressure test documentation status, venting conditions, and combustion air readiness. Note any gap that would prevent concealment authorization.',
    whatToCheck: [
      'Gas piping is routed, supported, and protected at vulnerable locations per permit.',
      'Gas shutoffs are present at each appliance location where required.',
      'Contractor-documented gas pressure test is on file where the applicable permit path requires it.',
      'Appliance venting is installed with correct material, slope, clearances, and exterior termination where applicable.',
      'Combustion air provisions are complete and unobstructed where fuel-fired appliances are installed.',
      'No gas piping has been concealed without documented inspection or pressure test status.',
    ],
    passWhen: [
      'Gas piping installation is complete and reviewable for the presented stage.',
      'Contractor-documented pressure test is on file where required.',
      'Venting and combustion air conditions support safe progression of the gas scope.',
    ],
    failWhen: [
      'Gas piping or venting is incomplete, unsupported, or deficient for the presented stage.',
      'Gas pressure test documentation is absent or has not been performed by a qualified contractor where required.',
      'Combustion air provisions are missing, blocked, or materially inadequate for the appliance setup.',
      'Gas piping has been concealed without documented inspection or pressure test status.',
    ],
    pendingWhen: [
      'Gas piping is substantially installed but pressure test documentation is pending completion.',
      'A Technical Safety BC or AHJ coordination item is outstanding and resolution is expected shortly.',
    ],
    requiredEvidence: [
      'Inspector-captured field photos showing gas piping routing, support, protection, shutoff locations, and venting conditions.',
      'Contractor pressure test record or Technical Safety BC inspection reference where required.',
    ],
    optionalEvidence: [
      'Supplemental venting detail photos.',
      'Combustion air pathway documentation.',
      'Installer or engineer coordination notes.',
    ],
    evidenceMode: 'required_upload',
    permitType: 'gas',
    responsibleParty: 'Inspector',
    documentUploadRequired: true,
    ahjNotes: 'Capture local gas piping, pressure test, venting clearance, shutoff, or combustion air requirements before concealment. Note Technical Safety BC coordination requirements specific to the jurisdiction.',
    dependencies: ['S11-01'],
    codeReferences: [
      {
        label: 'BC Safety Standards Act — Technical Safety BC gas piping, pressure testing, and inspection requirements',
        legalReference: 'BC Safety Standards Act, SBC 2003, c. 39',
        sourceTitle: 'Technical Safety BC',
        sourceUrl: 'https://www.technicalsafetybc.ca/gas',
      },
      {
        label: 'BC Building Code 2024 — Gas appliance venting, combustion air, and fuel-fired appliance requirements',
        legalReference: 'BCBC 2024 Division B, Part 6',
        sourceTitle: 'British Columbia Building Code 2024',
        sourceUrl: 'https://www.bccodes.ca/bc-building-code.html',
      },
      {
        label: 'Vancouver Building By-law 2025 — Gas piping, venting, and combustion air requirements where applicable',
        legalReference: 'VBBL 2025, Division B',
        sourceTitle: 'Vancouver Building By-law 2025',
        isVbblOnly: true,
      },
  ...
  {
    code: 'S11-03',
    label: 'Ventilation, Exhaust, Duct Coordination, and Fire Assembly Coordination',
    uiSchema: 'field_view',
    purpose: 'Confirm the building ventilation strategy, exhaust systems, duct coordination, and fire-rated assembly penetrations are installed and coordinated before enclosure.',
    viewDetails: 'Validate HRV or ERV installation and ducting where required, bathroom and kitchen exhaust routing to exterior, dryer exhaust termination, fresh-air intake and exhaust separation distances, fire and smoke dampers at rated-assembly penetrations where required, firestopping of mechanical penetrations through fire-rated assemblies, and condensate drainage provisions where applicable.',
    stopIf: [
      'Required ventilation, exhaust, or fire damper provisions are incomplete or absent at rated-assembly penetrations before concealment.',
    ],
    fieldChecklist: [
      'HRV or ERV installed, ducted, and positioned for balancing where required by applicable code or permit path? (Camera Evidence Required)',
      'Bathroom exhaust routed to exterior with correct termination clearances where applicable?',
      'Kitchen exhaust and dryer exhaust routed to exterior with correct clearances where applicable?',
      'Fresh-air intakes and exhaust terminations separated by required minimum distance where applicable?',
      'Fire or smoke dampers installed at rated-assembly penetrations where required by approved drawings or AHJ?',
      'Mechanical penetrations through fire-rated assemblies firestopped where applicable?',
      'Condensate drainage from HVAC equipment piped to correct location where applicable?',
    ],
    notesGuidance: 'Record HRV/ERV installation and ducting status, exhaust routing and termination conditions, fresh-air separation distances, fire damper and firestopping status, and condensate drainage conditions. Note any ventilation or fire-rated penetration gap remaining before enclosure.',
    whatToCheck: [
      'HRV or ERV is installed and ducted where required by the applicable code or permit path.',
      'Bathroom, kitchen, and dryer exhaust discharges to the exterior with required clearances where applicable.',
      'Fresh-air intakes and exhaust terminations are separated by the required distance where applicable.',
      'Fire or smoke dampers are installed at rated-assembly penetrations where required by approved drawings or AHJ.',
      'Mechanical penetrations through fire-rated assemblies are firestopped where applicable.',
      'Condensate drainage from HVAC equipment is piped correctly where applicable.',
    ],
    passWhen: [
      'Ventilation, exhaust, and fire-assembly coordination provisions are installed and reviewable for the presented stage.',
      'Air movement, termination, and fire-rated penetration conditions appear complete enough for downstream testing or final approval.',
    ],
    failWhen: [
      'A required ventilation or exhaust path is incomplete, incorrectly routed, or not terminated to exterior where required.',
      'Fire or smoke dampers are absent at rated-assembly penetrations where required by approved drawings or AHJ.',
      'Mechanical penetrations through fire-rated assemblies are not firestopped where required.',
      'Condensate drainage is absent or incorrectly piped where applicable.',
    ],
    pendingWhen: [
      'HRV/ERV ducting or exhaust routing is still being completed and requires re-inspection.',
      'Fire damper or firestopping installation is pending AHJ or engineer confirmation.',
    ],
    requiredEvidence: [
      'Inspector-captured field photos showing HRV/ERV installation, exhaust routing, termination conditions, fire damper locations, and firestopping where applicable.',
    ],
    optionalEvidence: [
      'Supplemental duct routing notes.',
      'Installer balancing or coordination records.',
      'Fire damper schedule or approved drawing reference.',
    ],
    evidenceMode: 'required_upload',
    permitType: 'mechanical_hvac',
    responsibleParty: 'Inspector',
    documentUploadRequired: true,
    ahjNotes: 'Capture local ventilation rate, exhaust termination clearance, fresh-air separation, HRV/ERV balancing, fire damper, firestopping, or condensate drainage requirements affecting enclosure approval.',
    dependencies: ['S11-02'],
    codeReferences: [
      {
        label: 'BC Building Code 2024 — Ventilation, exhaust, HRV/ERV, and fire damper requirements',
        legalReference: 'BCBC 2024 Division B, Part 6',
        sourceTitle: 'British Columbia Building Code 2024',
        sourceUrl: 'https://www.bccodes.ca/bc-building-code.html',
      },
      {
        label: 'BC Building Code 2024 — Fire protection and firestopping at mechanical penetrations',
        legalReference: 'BCBC 2024 Division B, Part 3',
        sourceTitle: 'British Columbia Building Code 2024',
        sourceUrl: 'https://www.bccodes.ca/bc-building-code.html',
      },
      {
        label: 'Vancouver Building By-law 2025 — Ventilation rate, HRV/ERV, and fire damper requirements where applicable',
        legalReference: 'VBBL 2025, Division B',
        sourceTitle: 'Vancouver Building By-law 2025',
        isVbblOnly: true,
      },
  ...
  {
    code: 'S11-04',
    label: 'Mechanical and Gas Inspection Closeout',
    uiSchema: 'field_view',
    purpose: 'Confirm the mechanical and gas scope has cleared the required Technical Safety BC inspection gates and documentation package before concealment or final closeout proceeds.',
    viewDetails: 'Validate the administrative closeout of the mechanical and gas scope, including Technical Safety BC gas inspection status, Declaration of Inspection on file where required, rough mechanical inspection status, and any correction items addressed. This container is the formal gate between installed mechanical and gas work and accepted work before the building scope advances.',
    stopIf: [
      'Technical Safety BC gas inspection has not passed or been documented, and gas piping concealment or appliance connection is imminent.',
      'Required rough mechanical inspection has not passed for the presented scope.',
    ],
    fieldChecklist: [
      'Technical Safety BC gas inspection passed or documented inspection status confirmed where applicable? (Gas inspection certificate or declaration reference required)',
      'Declaration of Inspection for gas submitted and on file where required by applicable permit path?',
      'Rough mechanical inspection passed or documented for the presented scope?',
      'Correction items from Technical Safety BC or AHJ identified and addressed where applicable?',
      'Final mechanical or gas approval status reflects readiness for concealment or closeout where applicable?',
      'Evidence package complete and sufficient to support closeout authorization?',
    ],
    notesGuidance: 'Record Technical Safety BC gas inspection status, Declaration of Inspection reference, rough mechanical inspection status, any outstanding correction items, and permit record state. Note any administrative hold that would block concealment or closeout.',
    whatToCheck: [
      'Technical Safety BC gas inspection has passed or is clearly documented for the presented scope where applicable.',
      'Declaration of Inspection for gas is on file where the applicable permit path requires it.',
      'Rough mechanical inspection has passed or is clearly documented for the presented scope.',
      'Correction items from Technical Safety BC or the AHJ have been addressed and documented.',
      'No outstanding mechanical or gas administrative hold remains that would block closeout.',
    ],
    passWhen: [
      'Required Technical Safety BC gas inspection gate is documented as cleared where applicable.',
      'Rough mechanical inspection has passed or is documented for the presented stage.',
      'No unresolved declaration, inspection, or approval item remains before closeout.',
    ],
    failWhen: [
      'Technical Safety BC gas inspection has not passed where required.',
      'Declaration of Inspection for gas is missing where required by the applicable permit path.',
      'Required rough or final mechanical inspection has not passed.',
      'Outstanding correction items from Technical Safety BC or AHJ are unresolved.',
    ],
    pendingWhen: [
      'Technical Safety BC gas inspection is scheduled but not yet completed.',
      'Declaration of Inspection is expected shortly and may resolve the documentation gap.',
    ],
    requiredEvidence: [
      'Technical Safety BC gas inspection certificate, Declaration of Inspection, or documented inspection status confirming mechanical and gas closeout.',
      'Rough mechanical inspection record or AHJ approval reference where applicable.',
    ],
    optionalEvidence: [
      'Supplemental notes documenting inspector feedback or outstanding conditions.',
      'Correction-item resolution records.',
    ...
    responsibleParty: 'Inspector',
    documentUploadRequired: true,
    ahjNotes: 'Capture local mechanical inspection, Technical Safety BC gas inspection, Declaration of Inspection, or AHJ approval conditions that must be satisfied before mechanical and gas closeout.',
    dependencies: ['S11-03'],
    codeReferences: [
      {
        label: 'BC Safety Standards Act — Technical Safety BC gas inspection and Declaration of Inspection requirements',
        legalReference: 'BC Safety Standards Act, SBC 2003, c. 39',
        sourceTitle: 'Technical Safety BC',
        sourceUrl: 'https://www.technicalsafetybc.ca/gas',
      },
      {
        label: 'BC Building Code 2024 — Inspection requirements before concealment of mechanical rough-in',
        legalReference: 'BCBC 2024 Division C, Part 2',
        sourceTitle: 'British Columbia Building Code 2024',
        sourceUrl: 'https://www.bccodes.ca/bc-building-code.html',
      },
      {
        label: 'Vancouver Building By-law 2025 — Mechanical and gas inspection closeout requirements where applicable',
        legalReference: 'VBBL 2025, Division C',
        sourceTitle: 'Vancouver Building By-law 2025',
        isVbblOnly: true,
      },
...
const STRUCTURAL_STAGE_12_CONTAINERS: StructuredStageItemDefinition[] = [
  {
    ...
    dependencies: ['S09-02', 'S10-04', 'S11-04'],
    codeReferences: [
      {
...
const STRUCTURAL_STAGE_13_CONTAINERS: StructuredStageItemDefinition[] = [
  {
    code: 'S13-01',
    label: 'Fire Separation, Rated Assemblies, and Sound Separation',
    uiSchema: 'field_view',
    purpose: 'Confirm fire-rated assemblies, shaft walls, service-chase continuity, firestopping at rated penetrations, and sound separation are in place before interior finishes obscure them.',
    viewDetails: 'Validate fire separation assembly type against approved drawings, Type X gypsum or equivalent on rated walls, shaft wall and service-chase continuity through floor-ceiling assemblies, firestopping at all rated penetrations, and suite-to-suite or dwelling-unit sound separation wall types. This sub-container protects the concealed life-safety layer of the interior package before finish work makes it inaccessible for review.',
    stopIf: [
      'Required firestopping at rated penetrations has not been applied before finishes will conceal them where applicable.',
      'Required fire separation assemblies are absent, incomplete, or inconsistent with approved drawings where applicable.',
    ],
    fieldChecklist: [
    ...
    notesGuidance: 'Record observed fire separation assembly conditions, firestopping application status at rated penetrations, and sound separation details before finishes obscure them.',
    whatToCheck: [
      'Fire separation assembly type is consistent with approved drawings where applicable.',
      'Type X or equivalent gypsum board is installed on required rated walls where triggered by permit scope.',
      'Shaft walls and service chases are complete and continuous through floor-ceiling assemblies where required.',
      'Firestopping at rated penetrations is applied before interior finishes will conceal them.',
      'Sound separation assemblies at suite or dwelling-unit interfaces match the required type where applicable.',
      'No observed break, gap, or missing continuity in required rated or sound-separation assemblies.',
    ],
    passWhen: [
      'Fire-rated assemblies, firestopping at rated penetrations, and sound separation assemblies are complete for the reviewed scope.',
      'No missing or deficient rated element remains that would be difficult to correct after finishes proceed.',
    ],
    failWhen: [
      'Required fire separation assemblies are absent or inconsistent with approved drawings where applicable.',
      'Firestopping at rated penetrations is missing or incomplete before finishes will conceal them.',
      'Required sound separation wall or floor-ceiling assembly type is absent or incorrect where applicable.',
    ],
    pendingWhen: [
      'Firestopping or rated assembly work is still being completed and requires a return inspection before finish concealment.',
      'Documentation for a ULC-listed system or rated assembly detail is outstanding and required by AHJ.',
    ],
    requiredEvidence: [
      'Inspector-captured field photos showing fire separation assembly conditions, firestopping application at rated penetrations, and sound separation details before finishes obscure them.',
    ],
    optionalEvidence: [
      'ULC-listed assembly reference or manufacturer data sheet where required.',
      'Supplemental firestopping application photos.',
      'Sound separation wall type documentation.',
    ],
    evidenceMode: 'required_upload',
    permitType: 'building',
    responsibleParty: 'Inspector',
    documentUploadRequired: true,
    ahjNotes: 'Capture local fire separation, firestopping, and sound separation requirements that must be confirmed before interior finishes proceed.',
    dependencies: ['S12-04'],
    codeReferences: [
      {
        label: 'BC Building Code 2024 — Division B, Part 9: Fire Separation and Sound Separation',
        legalReference: 'BCBC 2024, Division B, Part 9',
      },
      {
        label: 'BC Building Code 2024 — Division B, Part 3: Fire Separations and Means of Egress',
        legalReference: 'BCBC 2024, Division B, Part 3',
      },
      {
        label: 'Vancouver Building By-law 2025 — Division B: Suite Separation and Sound Attenuation',
        legalReference: 'VBBL 2025, Division B',
        isVbblOnly: true,
      },
    ],
  ...
  {
    code: 'S13-02',
    label: 'Interior Wall Substrate, Wet-Area, and Concealed Backing',
    uiSchema: 'field_view',
    purpose: 'Confirm interior wall substrate types, moisture-resistant and wet-area board installation, waterproofing preparation, and concealed backing are complete before finish closure obscures them.',
    viewDetails: 'Validate drywall board type for each application area, moisture-resistant board where required, tile backer or waterproof board at tub and shower surrounds, waterproofing membrane application, grab bar blocking, and cabinet and countertop backing. This sub-container confirms the concealed substrate layer is complete before finish materials are applied.',
    stopIf: [
      'Required wet-area tile backer, waterproof board, or waterproofing membrane has not been applied before tile or finish materials are installed where required.',
      'Required moisture-resistant substrate is absent in areas where it will no longer be accessible after finishes proceed.',
    ],
    fieldChecklist: [
    ...
    notesGuidance: 'Record observed substrate types, wet-area board conditions, waterproofing application status, and concealed backing before finish materials are applied.',
    whatToCheck: [
      'Drywall board type is appropriate for each application area where triggered by permit scope.',
      'Moisture-resistant board is installed where required.',
      'Tile backer or waterproof board is present at tub and shower surrounds before tile installation where applicable.',
      'Waterproofing membrane or wet-area preparation is applied where required by approved drawings.',
      'Grab bar blocking is installed where adaptable housing or accessibility conditions apply.',
      'Cabinet and countertop backing is present where applicable.',
      'No substrate gap, board-type mismatch, or missing wet-area preparation remains before finish closure.',
    ],
    passWhen: [
      'Interior wall substrates, wet-area board, waterproofing preparation, and concealed backing are complete for the reviewed scope.',
      'No missing substrate or backing condition remains that would be difficult to correct after finish materials are applied.',
    ],
    failWhen: [
      'Required tile backer or waterproof board is absent at tub or shower surrounds where required.',
      'Moisture-resistant substrate is missing where required for the reviewed application area.',
      'Waterproofing membrane or wet-area preparation is absent where required by approved drawings.',
      'Grab bar blocking is missing where required by the permit path.',
    ],
    pendingWhen: [
      'Wet-area substrate or waterproofing work is still being completed and requires a return inspection before finish closure.',
      'Blocking or backing corrections are expected before the stage can be accepted.',
    ],
    requiredEvidence: [
      'Inspector-captured field photos showing wet-area tile backer, moisture-resistant substrate conditions, waterproofing application, and concealed backing before finishes obscure them.',
    ],
    optionalEvidence: [
      'Manufacturer data sheet for waterproofing membrane where required.',
      'Supplemental room notes.',
      'Coordination records for accessibility or adaptable housing backing.',
    ],
    evidenceMode: 'required_upload',
    permitType: 'building',
    responsibleParty: 'Inspector',
    documentUploadRequired: true,
    ahjNotes: 'Capture local substrate, wet-area, or waterproofing requirements that must be confirmed before finish materials are applied.',
    dependencies: ['S13-01'],
    codeReferences: [
      {
        label: 'BC Building Code 2024 — Division B, Part 9: Interior Wall Substrate and Wet-Area Requirements',
        legalReference: 'BCBC 2024, Division B, Part 9',
      },
      {
        label: 'Vancouver Building By-law 2025 — Division B: Interior Finish and Wet-Area Requirements',
        legalReference: 'VBBL 2025, Division B',
        isVbblOnly: true,
      },
    ],
  ...
  {
    code: 'S13-03',
    label: 'Interior Life Safety and Egress Readiness',
    uiSchema: 'field_view',
    purpose: 'Confirm interior guards, handrails, egress hardware, fire doors, smoke alarms, CO detectors, and emergency lighting are installed and observable before interior closeout proceeds.',
    viewDetails: 'Validate interior guards at open sides of stairs, landings, balconies, and mezzanines; handrails on required stair sides with graspable profile and return ends; egress door swing, clear opening, and hardware at required exits; fire door self-closers, latches, smoke seals, and signage; smoke alarm locations consistent with permit documents; CO detector placement near fuel-fired appliance spaces; and emergency lighting and exit signage where required by occupancy class.',
    stopIf: [
      'Required interior guards or handrails are absent at open sides of stairs, landings, or mezzanines where the deficiency presents an immediate fall hazard.',
      'Required egress door hardware, fire door self-closers, or smoke seals are absent where the deficiency affects means of egress.',
    ],
    fieldChecklist: [
      'Interior guards installed at open sides of stairs, landings, balconies, and mezzanines where required.',
      'Handrails installed on required stair sides with graspable profile and return ends where required.',
      'Egress door swing, clear opening, and hardware confirmed at required exits where applicable.',
      'Fire door self-closers, latches, smoke seals, and signage present where required by approved assembly drawings.',
      'Smoke alarm locations visible and consistent with permit documents where applicable.',
      'CO detectors installed in proximity to fuel-fired appliance spaces and bedrooms where required.',
      'Emergency lighting and exit signage in place where required by occupancy class or permit path.',
    ],
    notesGuidance: 'Record observed guard and handrail installation conditions, egress hardware status, fire door assembly details, and alarm device locations.',
    whatToCheck: [
      'Interior guards are installed at all required open sides of stairs, landings, balconies, and mezzanines where applicable.',
      'Handrails on required stair sides have graspable profiles and return ends where required.',
      'Egress doors have correct swing direction, clear opening width, and hardware where triggered by permit scope.',
      'Fire doors have self-closers, latches, smoke seals, and required signage where applicable.',
      'Smoke alarm locations are consistent with permit documents and observable.',
      'CO detectors are installed near fuel-fired appliance spaces and sleeping areas where required.',
      'Emergency lighting and exit signage are in place where required by occupancy class or permit path.',
    ],
    passWhen: [
      'Interior life safety elements, egress hardware, alarm devices, and emergency lighting are complete for the reviewed scope.',
      'No missing guard, handrail, egress hardware, or alarm device remains that would affect life safety or means of egress.',
    ],
    failWhen: [
      'Required interior guards or handrails are absent or deficient where required.',
      'Egress door hardware or fire door assembly elements are missing or inconsistent with approved drawings where applicable.',
      'Smoke alarms or CO detectors are absent where required.',
    ],
    pendingWhen: [
      'Alarm device or egress hardware installation is still being completed and requires a return inspection.',
      'A localized guard, handrail, or fire door correction is expected before the stage can be accepted.',
    ],
    requiredEvidence: [
      'Inspector-captured field photos showing interior guard and handrail conditions, egress hardware, fire door assemblies, and alarm device locations.',
    ],
    optionalEvidence: [
      'Fire door listing or certification documentation where required.',
      'Supplemental stair and guard detail notes.',
      'Alarm system installer records where applicable.',
    ],
    evidenceMode: 'required_upload',
    permitType: 'building',
    responsibleParty: 'Inspector',
    documentUploadRequired: true,
    ahjNotes: 'Capture local guard height, handrail profile, egress hardware, fire door, and alarm device requirements that must be confirmed before interior closeout.',
    dependencies: ['S13-02'],
    codeReferences: [
      {
        label: 'BC Building Code 2024 — Division B, Part 9: Guards, Stairs, Handrails, and Smoke Alarms',
        legalReference: 'BCBC 2024, Division B, Part 9',
      },
      {
        label: 'BC Building Code 2024 — Division B, Part 3: Means of Egress, Fire Doors, and Emergency Lighting',
        legalReference: 'BCBC 2024, Division B, Part 3',
      },
      {
        label: 'Vancouver Building By-law 2025 — Division B: Interior Life Safety and Egress Requirements',
        legalReference: 'VBBL 2025, Division B',
        isVbblOnly: true,
      },
    ],
  ...
  {
    code: 'S13-04',
    label: 'Interior Finishes and Systems Trim',
    uiSchema: 'field_view',
    purpose: 'Confirm interior finish components and final building systems trim are complete enough for occupancy readiness.',
    viewDetails: 'Validate interior doors, hardware, flooring, cabinetry, and millwork; flame-spread or fire-performance compliance of interior finish materials; HVAC grilles, diffusers, thermostats, and controls; plumbing trim fixtures; and electrical trim devices. This sub-container tracks the visible interior completion layer that supports functional readiness of the occupied space.',
    stopIf: [
      'Critical interior trim or system completion gaps remain that would prevent safe or functional use of the space.',
    ],
    fieldChecklist: [
      'Interior doors, hardware, flooring, cabinetry, and millwork installed where required for stage readiness.',
      'Interior finish materials meet applicable flame-spread or fire-performance requirements where required.',
      'HVAC grilles, diffusers, thermostats, and controls installed and accessible where applicable.',
      'Plumbing trim fixtures installed and operational where required for stage readiness.',
      'Electrical trim devices, plates, and cover panels installed at required locations.',
      'No visible finish deficiency remains that would affect life safety, egress, or AHJ closeout.',
    ],
    notesGuidance: 'Record the completion state of interior finish carpentry, trim, and visible systems; note any missing element affecting function, safety, or readiness for closeout.',
    whatToCheck: [
      'Interior doors, hardware, flooring, cabinetry, and millwork are installed where required for the reviewed stage.',
      'Interior finish materials meet applicable flame-spread or fire-performance requirements where triggered by permit scope.',
      'HVAC grilles, diffusers, thermostats, and controls are installed and accessible.',
      'Plumbing trim fixtures are installed and operational where required.',
      'Electrical trim devices, cover plates, and panel covers are installed at required locations.',
      'No visible finish or trim omission remains that would affect life safety, egress, or AHJ closeout.',
    ],
    passWhen: [
      'Interior finishes and systems trim are complete enough for the presented stage.',
      'No missing finish, trim, or device remains that would affect life safety or functional interior use.',
    ],
    failWhen: [
      'Critical doors, hardware, flooring, or millwork remain incomplete for the reviewed scope.',
      'Interior finish materials do not meet applicable flame-spread requirements where required.',
      'Required plumbing trim, electrical trim, or HVAC trim is missing or materially incomplete.',
    ],
    pendingWhen: [
    ...
    optionalEvidence: [
      ...
      'Flame-spread rating documentation for finish materials where required.',
    ],
    evidenceMode: 'required_upload',
    permitType: 'building',
    responsibleParty: 'Inspector',
    documentUploadRequired: true,
    ahjNotes: 'Capture local finish material compliance, trim, or interior completion requirements that affect readiness for occupancy review.',
    dependencies: ['S13-03'],
    codeReferences: [
      {
        label: 'BC Building Code 2024 — Division B, Part 9: Interior Finishes and Flame Spread',
        legalReference: 'BCBC 2024, Division B, Part 9',
      },
      {
        label: 'BC Building Code 2024 — Division B, Part 3: Interior Finish Flame-Spread Requirements',
        legalReference: 'BCBC 2024, Division B, Part 3',
      },
      {
        label: 'Vancouver Building By-law 2025 — Division B: Interior Finish Requirements',
        legalReference: 'VBBL 2025, Division B',
        isVbblOnly: true,
      },
    ],
  ...
  {
    code: 'S13-05',
    label: 'Accessibility, Adaptable Housing, and Interior Closeout',
    uiSchema: 'field_view',
    purpose: 'Confirm accessibility clearances, adaptable housing elements, and interior documentation are complete before progressing to exterior finalization and final occupancy stages.',
    viewDetails: 'Validate accessible or adaptable suite door clear-opening widths, turning clearance at accessible bathroom or kitchen, zero-step or low-threshold principal entry, lowered light switches and outlets at required heights, required grab bar blocking, and interior stage documentation package. This sub-container captures the last interior readiness layer before the project transitions to S14.',
    stopIf: [
      'Required accessibility or adaptable housing elements are absent and cannot be corrected after interior finishes have progressed.',
    ...
    fieldChecklist: [
      ...
      'Required grab bar blocking and adaptable housing elements confirmed where applicable.',
      'All interior stage deficiencies from S13-01 through S13-04 resolved or formally documented.',
      'Interior documentation package complete before progressing to S14.',
    ],
    notesGuidance: 'Record observed accessibility clearance conditions, adaptable housing element installation status, and the completeness of the interior documentation package.',
    whatToCheck: [
      'Accessible or adaptable suite door clear-opening widths are confirmed where required by permit path.',
      'Turning clearance at accessible bathroom or kitchen is confirmed where required.',
      'Zero-step or low-threshold principal entry is present where required by applicable code or permit path.',
      'Lowered switches, outlets, or controls are at required heights where adaptable housing path applies.',
      'Required grab bar blocking and adaptable housing elements are confirmed where applicable.',
      'All identified deficiencies from S13-01 through S13-04 are resolved or formally documented.',
      'Interior documentation package is complete before progression to S14.',
    ],
    passWhen: [
      'Accessibility and adaptable housing elements are complete for the reviewed scope.',
      'Interior stage documentation is complete and the interior package is ready to transition to S14.',
    ],
    failWhen: [
      'Required accessibility clearances or adaptable housing elements are absent where required by the permit path.',
      'Identified deficiencies from earlier S13 sub-containers remain unresolved and undocumented.',
    ],
    pendingWhen: [
      'Accessibility or adaptable housing element installation is still being completed and requires a return inspection.',
      'Interior documentation is outstanding and required before the stage can be accepted.',
    ],
    requiredEvidence: [
      'Inspector-captured field photos showing accessible door widths, turning clearances, entry threshold conditions, and adaptable housing elements in the reviewed area.',
    ],
    optionalEvidence: [
      'Supplemental accessibility closeout notes.',
      'Finish-schedule or adaptable housing plan references.',
      'Coordination comments from accessibility review.',
    ],
    evidenceMode: 'required_upload',
    permitType: 'building',
    responsibleParty: 'Inspector',
    documentUploadRequired: true,
    ahjNotes: 'Capture local accessibility, adaptable housing, and interior closeout requirements that must be satisfied before progressing to S14.',
    dependencies: ['S13-04'],
    codeReferences: [
      {
        label: 'BC Building Code 2024 — Division B, Part 9: Accessibility and Adaptable Housing',
        legalReference: 'BCBC 2024, Division B, Part 9',
      },
      {
        label: 'Vancouver Building By-law 2025 — Division B: Accessibility and Adaptable Housing Requirements',
        legalReference: 'VBBL 2025, Division B',
        isVbblOnly: true,
      },
      {
        label: 'Vancouver Building By-law 2025 — Division C: Administrative Closeout Requirements',
        legalReference: 'VBBL 2025, Division C',
        isVbblOnly: true,
      },
    ],
...
const STRUCTURAL_STAGE_14_CONTAINERS: StructuredStageItemDefinition[] = [
  {
    code: 'S14-01',
    label: 'Exterior Cladding, Envelope, and Weather-Resistive Continuity',
    uiSchema: 'field_view',
    purpose: 'Confirm exterior cladding, weather-resistive barrier continuity, flashings, and weather-shedding details are complete and consistent with approved drawings where applicable.',
    viewDetails: 'Validate exterior cladding installation, drainage plane continuity, flashing at openings and penetrations, sill pan details, sealant joints, trim and soffit completion, and roof-to-wall or deck-to-wall transitions. This sub-container protects the building envelope from water infiltration and confirms the exterior weather-resistive layer is complete before final site review proceeds.',
    stopIf: [
      'Required flashings or weather-resistive barrier are absent at penetrations, openings, or wall transitions that will be concealed by cladding or trim where applicable.',
      'Exterior cladding is inconsistent with approved drawings in a way that cannot be resolved without removing installed work where required by AHJ.',
    ],
    dependencies: ['S13-05'],
    fieldChecklist: [
      ...
      'Exterior trim, fascia, and soffit complete and secured where applicable.',
      'Deck-to-wall and roof-to-wall transitions flashed and sealed where required by approved drawings.',
    ],
    notesGuidance: 'Record observed cladding type, WRB or drainage-plane continuity, flashing conditions at openings and penetrations, sill pan presence, sealant joints, and any exterior envelope deficiency requiring correction.',
    whatToCheck: [
      'Cladding type matches approved drawings for the reviewed elevations.',
      'Weather-resistive barrier or drainage plane is continuous with no observed gaps, tears, or reverse laps at the reviewed areas.',
      'Flashings are installed at all window heads, door heads, wall penetrations, and cladding transitions visible during inspection.',
      'Sill pans or equivalent details are present at window and door sills where required.',
      'Sealant is applied at trim joints, penetrations, and cladding-to-trim interfaces where required.',
      'Trim, fascia, and soffit are secured and complete for the reviewed scope.',
      'Deck-to-wall and roof-to-wall transition flashings are installed and lapped correctly where applicable.',
    ],
    passWhen: [
      'Cladding installation is consistent with approved drawings for the reviewed scope.',
      'Weather-resistive barrier or drainage plane continuity is confirmed at reviewed areas.',
      'Flashings, sill pans, and sealant joints are present where required for the reviewed scope.',
      'No observed exterior envelope deficiency remains that would allow water infiltration at vulnerable transitions.',
    ],
    failWhen: [
      'Cladding type or installation is inconsistent with approved drawings in a material way.',
      'Weather-resistive barrier or drainage plane is absent, reversed, or materially compromised at observed locations.',
      'Required flashings are missing at window heads, door heads, or penetrations.',
      'Sill pans or equivalent detail are absent where required for the reviewed scope.',
      'Sealant gaps or missing sealant are observed at vulnerable exterior penetrations or transitions.',
    ],
    pendingWhen: [
      'Cladding or envelope work is still in progress and requires a return inspection.',
      'A specific flashing or sealant correction is expected before acceptance.',
      'Approved drawings or product documentation has been requested and not yet received where required by AHJ.',
    ],
    requiredEvidence: [
      'Inspector-captured field photos showing cladding installation, WRB or drainage plane continuity, flashings at openings, and sill pan conditions.',
    ],
    optionalEvidence: [
      'Cladding product documentation or installation instructions.',
      'WRB product reference or lap-detail photos.',
      'Supplemental notes on observed envelope conditions.',
    ],
    evidenceMode: 'required_upload',
    permitType: 'building',
    responsibleParty: 'Inspector',
    documentUploadRequired: true,
    ahjNotes: 'Capture local exterior-cladding, flashing, or weather-resistive barrier requirements that must be satisfied before final site acceptance. Note any AHJ-specific product approval or installation requirements.',
    codeReferences: [
      {
        label: 'BC Building Code 2024 — Division B, Part 9: Exterior Cladding, Flashings, and Drainage Plane',
        legalReference: 'BCBC 2024, Division B, Part 9',
      },
      {
        label: 'BC Building Code 2024 — Division B, Part 5: Environmental Separation and Exterior Envelope',
        legalReference: 'BCBC 2024, Division B, Part 5',
      },
      {
        label: 'Vancouver Building By-law 2025 — Division B: Exterior Envelope and Weather-Resistive Requirements',
        legalReference: 'VBBL 2025, Division B',
        isVbblOnly: true,
      },
    ],
  ...
  {
    code: 'S14-02',
    label: 'Exterior Stairs, Decks, Guards, and Handrails',
    uiSchema: 'field_view',
    purpose: 'Confirm exterior stairs, decks, guards, handrails, ramps, and walking surfaces are structurally complete and meet life-safety requirements where applicable.',
    viewDetails: 'Validate exterior stair geometry, deck ledger connections, guard heights and infill spacing, handrail continuity, ramp slopes and landings, and walking surface conditions. This sub-container confirms the exterior life-safety features that protect occupants from fall hazards are complete before site-access review proceeds.',
    stopIf: [
      'An exterior guard is absent or incomplete at an elevated walking surface where a fall hazard exists and occupants may access the area.',
      'An exterior stair, deck, or landing condition presents an immediate observed life-safety hazard that cannot be used safely in its current state.',
    ],
    fieldChecklist: [
      ...
      'Ramp slope and intermediate landings confirmed where triggered by accessible route design.',
      'Walking surfaces complete, stable, and free of observed life-safety hazards.',
    ],
    notesGuidance: 'Record observed stair geometry, handrail height and continuity, guard height and infill spacing, deck ledger connection conditions, ramp slope and landing dimensions, and any walking-surface deficiency.',
    whatToCheck: [
      'Stair rise and run are consistent and within reviewed tolerance for the exterior flights.',
      'Handrails are installed at the required height and run continuously for the full flight where required.',
      'Deck ledger connections and visible hardware are present and appear secure where applicable.',
      'Guard height at elevated decks, balconies, or landings meets minimum where required.',
      'Guard infill spacing is confirmed at observed panels where required.',
      'Ramp slope and intermediate landing dimensions are confirmed where an accessible exterior route is required.',
      'Walking surfaces are complete, stable, and free of observed trip hazards or structural instability.',
    ],
    passWhen: [
      'Exterior stair geometry, handrail continuity, guard height and infill, and walking surfaces are confirmed for the reviewed scope.',
      'Deck ledger connections, ramp slopes, and landings support safe use for the reviewed scope.',
      'No observed life-safety deficiency remains at exterior stairs, guards, or handrails.',
    ],
    failWhen: [
      'Exterior guard is absent, below required height, or has infill spacing that exceeds permitted limits where required.',
      'Handrail is missing, discontinuous, or below required height for the reviewed flight.',
      'Exterior stair rise or run variation exceeds reviewed tolerance where required by approved drawings.',
      'Walking surface presents an observed trip hazard or structural instability that compromises safe use.',
    ],
    pendingWhen: [
      'Exterior stair, guard, handrail, or deck work is still in progress and requires a return inspection.',
      'A guard, handrail, or ramp correction is expected before acceptance.',
      'Measurement or product documentation has been requested from the builder and not yet received.',
    ],
    requiredEvidence: [
      'Inspector-captured field photos showing exterior guard conditions, handrail installation, stair flight, deck ledger, and walking surface completeness.',
    ],
    optionalEvidence: [
      'Supplemental measurement notes for stair geometry or guard height.',
      'Deck ledger connection detail or hardware documentation.',
      'Ramp slope measurement notes.',
    ],
    evidenceMode: 'required_upload',
    permitType: 'building',
    responsibleParty: 'Inspector',
    documentUploadRequired: true,
    ahjNotes: 'Capture local guard height, handrail, stair geometry, or exterior life-safety requirements that must be confirmed before final site acceptance. Note any AHJ-specific dimensional or structural requirements.',
    dependencies: ['S14-01'],
    codeReferences: [
      {
        label: 'BC Building Code 2024 — Division B, Part 9: Exterior Stairs, Guards, Handrails, and Ramps',
        legalReference: 'BCBC 2024, Division B, Part 9',
      },
      {
        label: 'BC Building Code 2024 — Division B, Part 3: Guards, Means of Egress, and Exterior Life-Safety Conditions',
        legalReference: 'BCBC 2024, Division B, Part 3',
      },
      {
        label: 'Vancouver Building By-law 2025 — Division B: Exterior Life-Safety and Accessible Route Requirements',
        legalReference: 'VBBL 2025, Division B',
        isVbblOnly: true,
      },
    ],
  ...
  {
    code: 'S14-03',
    label: 'Site Grading, Drainage, and Stormwater Control',
    uiSchema: 'field_view',
    purpose: 'Confirm final site grading, drainage pathways, downspout discharge, stormwater control, and erosion management are complete and direct water away from the building where applicable.',
    viewDetails: 'Validate final grading slopes away from the building, swales and drainage channels, downspout discharge locations and termination, perimeter foundation drainage, storm sewer or civil drainage connections, sump discharge routing, and erosion and sediment control measures. This sub-container protects the building and adjacent properties from post-construction water damage and confirms site drainage is ready for final occupancy.',
    stopIf: [
      'Final site grading directs water toward the building foundation in a way that creates an immediate risk of water entry or foundation damage where required by approved drawings.',
    ...
    fieldChecklist: [
      ...
      'Storm sewer connection point or civil drainage connection documented where required by servicing approval.',
      'Sump discharge routed away from the building or to approved outlet where applicable.',
      'Erosion and sediment control measures in place for disturbed areas where required.',
    ],
    notesGuidance: 'Record observed grading slope direction, swale and drainage path condition, downspout discharge location, perimeter drainage outlet status, storm sewer connection status, sump discharge routing, and erosion control measures at disturbed areas.',
    whatToCheck: [
      'Final grading at the building perimeter slopes away from the foundation where required.',
      'Swales and drainage channels are present, complete, and unobstructed at reviewed locations.',
      'Downspouts discharge to a splash pad, splash block, storm connection, or accepted outlet at sufficient distance from the foundation.',
      'Perimeter foundation drainage outlet is located and accessible where applicable.',
      'Storm sewer connection or civil drainage connection is documented where required by the site servicing approval.',
      'Sump discharge is routed away from the building or to an approved outlet where applicable.',
      'Erosion and sediment control measures are in place at disturbed soil areas where required.',
    ],
    passWhen: [
      'Final grading slopes away from the building and downspout discharge is confirmed at accepted outlets for the reviewed scope.',
      'Swales, drainage paths, storm connections, sump discharge, and erosion control measures are confirmed where required by the reviewed scope.',
      'No observed site drainage deficiency remains that would create water-entry risk or drainage failure at the building.',
    ],
    failWhen: [
      'Final grading directs water toward the building foundation or creates observed ponding risk at the foundation perimeter.',
      'Downspout discharge is directed toward the building, below-grade areas, or at a location that would concentrate water at the foundation.',
      'Required storm sewer connection or civil drainage connection is absent or blocked where required by servicing approval.',
      'Erosion control measures are absent at materially disturbed soil areas where required.',
    ],
    pendingWhen: [
      'Final grading or drainage work is still in progress and requires a return inspection.',
      'Civil servicing connection documentation has been requested and not yet received where required.',
      'A localized drainage or erosion control correction is expected before acceptance.',
    ],
    requiredEvidence: [
      'Inspector-captured field photos showing final grading conditions, downspout discharge locations, drainage paths, and erosion control measures.',
    ],
    optionalEvidence: [
      'Civil servicing completion records or drainage design reference.',
      'Sump discharge routing documentation.',
      'Overview photos documenting swales and drainage pathways.',
    ],
    evidenceMode: 'required_upload',
    permitType: 'building',
    responsibleParty: 'Inspector',
    documentUploadRequired: true,
    ahjNotes: 'Capture local grading, drainage, stormwater, or civil servicing requirements that must be confirmed before final site acceptance. Note that storm sewer connections and civil drainage approvals are third-party approvals; Vero inspectors confirm observable conditions only and do not certify civil engineering work.',
    dependencies: ['S14-02'],
    codeReferences: [
      {
        label: 'BC Building Code 2024 — Division B, Part 9: Site Grading, Drainage, and Surface Water Control',
        legalReference: 'BCBC 2024, Division B, Part 9',
      },
      {
        label: 'BC Building Code 2024 — Division B, Part 3: Site Drainage and Environmental Separation',
        legalReference: 'BCBC 2024, Division B, Part 3',
      },
      {
        label: 'Vancouver Building By-law 2025 — Division B: Site Stormwater Management and Drainage Requirements',
        legalReference: 'VBBL 2025, Division B',
        isVbblOnly: true,
      },
    ],
  ...
  {
    code: 'S14-04',
    label: 'Site Access, Servicing, Fire Authority Requirements, and Exterior Systems',
    uiSchema: 'field_view',
    purpose: 'Confirm pedestrian access, vehicle access, accessible exterior route, fire department access requirements, address visibility, and exterior mechanical, electrical, and plumbing system components are complete where applicable.',
    viewDetails: 'Validate walkway and driveway completion, accessible exterior route readiness, address number installation and visibility, fire department access clearance, fire route signage, hydrant clearance, and exterior service components including electrical service, gas meter, utility equipment, HVAC condensers, exhaust vents, and exterior plumbing. This sub-container confirms the site is accessible for emergency services, utilities are complete, and exterior systems are in final condition before landscape and closeout review.',
    stopIf: [
      'Fire department access to the building is obstructed in a way that cannot support emergency vehicle approach where required by fire authority or AHJ.',
      'Address numbers are absent and the building cannot be identified from the street or fire access route.',
    ],
    fieldChecklist: [
      'Pedestrian walkway to primary entry complete and usable where required.',
      'Accessible exterior route complete where triggered by permit path or occupancy type.',
      'Driveway, parking, or vehicle access complete where required by approved drawings.',
      'Address numbers installed and visible from the street or fire access route.',
      'Fire department access clearance confirmed where required by AHJ or fire authority.',
      'Hydrant clearance or fire route signage confirmed where required.',
      'Exterior electrical service, meter, disconnect, or utility equipment complete where applicable.',
      'Gas meter, regulator, exterior shutoff, vents, exhausts, condensers, hose bibs, or exterior mechanical and plumbing components complete and accessible where applicable.',
    ],
    notesGuidance: 'Record observed pedestrian and vehicle access conditions, accessible route status, address number installation, fire access and hydrant clearance conditions, fire route signage, and the completion status of exterior electrical, gas, HVAC, and plumbing components.',
    whatToCheck: [
      'Pedestrian walkway to the primary entry is complete and usable for the reviewed scope.',
      'Accessible exterior route is complete where required by permit path or occupancy type.',
      'Driveway or vehicle access area is complete where required by approved drawings.',
      'Address numbers are installed and visible from the street or fire access route.',
      'Fire department access clearance is maintained where required by fire authority or AHJ.',
      'Hydrant clearance and fire route signage are confirmed where required.',
      'Exterior electrical service entrance, meter, and disconnect are complete where applicable.',
      'Gas meter, regulator, shut-off, vents, HVAC condensers, exhausts, hose bibs, and exterior plumbing components are installed and accessible where applicable.',
    ],
    passWhen: [
      'Pedestrian walkway, accessible exterior route, and vehicle access are confirmed complete for the reviewed scope.',
      'Address numbers are visible from the street or fire access route.',
      'Fire department access clearance, hydrant clearance, and fire route signage are confirmed where required.',
      'Exterior electrical, gas, HVAC, and plumbing components are complete and accessible for the reviewed scope.',
    ],
    failWhen: [
      'Pedestrian walkway to the primary entry is incomplete or unusable.',
      'Accessible exterior route is missing or materially deficient where required by permit path.',
      'Address numbers are absent, obstructed, or not visible from the street.',
      'Fire department access is obstructed or fire route signage is missing where required.',
      'Required exterior electrical, gas, or mechanical components are absent or incomplete.',
    ],
    pendingWhen: [
      'Driveway, accessible route, or address signage installation is still in progress and requires a return inspection.',
      'Fire authority confirmation or utility servicing completion is pending and expected before acceptance.',
      'An exterior system component correction is expected before acceptance.',
    ],
    requiredEvidence: [
      'Inspector-captured field photos showing address number visibility, pedestrian walkway, accessible route, fire access conditions, driveway, and exterior system component completion.',
    ],
    optionalEvidence: [
      'Fire authority access confirmation or correspondence.',
      'Utility servicing completion records.',
      'Accessible route measurement or route continuity notes.',
    ],
    evidenceMode: 'required_upload',
    permitType: 'building',
    responsibleParty: 'Inspector',
    documentUploadRequired: true,
    ahjNotes: 'Capture local fire access, fire route signage, hydrant clearance, address visibility, accessible route, or utility servicing requirements that must be confirmed before final site acceptance. Note that fire authority approvals and utility servicing clearances are third-party; Vero inspectors confirm observable conditions and documented compliance only.',
    dependencies: ['S14-03'],
    codeReferences: [
      {
        label: 'BC Building Code 2024 — Division B, Part 9: Site Access, Pedestrian Routes, and Exterior Servicing',
        legalReference: 'BCBC 2024, Division B, Part 9',
      },
      {
        label: 'BC Building Code 2024 — Division B, Part 3: Fire Department Access, Address Visibility, and Site Safety',
        legalReference: 'BCBC 2024, Division B, Part 3',
      },
      {
        label: 'Vancouver Building By-law 2025 — Division B: Site Access, Accessible Route, and Exterior Systems Requirements',
        legalReference: 'VBBL 2025, Division B',
        isVbblOnly: true,
      },
    ],
  ...
  {
    code: 'S14-05',
    label: 'Landscaping, Site Restoration, and Final Exterior Closeout',
    uiSchema: 'field_view',
    purpose: 'Confirm landscape and softscape restoration, erosion control, tree compliance, site cleanup, and exterior deficiency resolution are complete before final closeout documentation is submitted to S15.',
    viewDetails: 'Validate disturbed soil surface cover, landscaping and softscape restoration, erosion control or slope stabilization, tree protection or arborist compliance records where required, site cleanup, resolution of exterior deficiencies from S14-01 through S14-04, and readiness of the exterior documentation package for S15 final review. This sub-container closes the exterior site layer and confirms that all outstanding site conditions are resolved or formally documented before final occupancy review.',
    stopIf: [
      'Required tree compliance sign-off, arborist records, or environmental restoration documentation has not been received where required by AHJ or Vancouver-specific bylaw path.',
      'Exterior deficiencies from S14-01 through S14-04 remain unresolved and undocumented in a way that would block progression to final occupancy.',
    ],
    fieldChecklist: [
      ...
      'Exterior documentation package ready for S15 final closeout review.',
    ],
    notesGuidance: 'Record observed soil cover and landscaping restoration conditions, erosion control measure status, tree compliance or arborist record status, site cleanup observations, status of exterior deficiencies from prior S14 sub-inspections, and readiness of the exterior documentation package for S15.',
    whatToCheck: [
      'Disturbed soil areas are covered with an approved surface treatment where required.',
      'Landscaping and softscape restoration are complete for the reviewed scope.',
      'Erosion control measures are installed and stable at disturbed slopes or areas where required.',
      'Tree protection, arborist, or retention compliance records are available where required by AHJ or Vancouver-specific bylaw path.',
      'Construction debris and waste materials have been removed from exterior site areas.',
      'Outstanding exterior deficiencies from S14-01 through S14-04 have been resolved or formally documented.',
      'The exterior documentation package is assembled and ready for S15 final review.',
    ],
    passWhen: [
      'Soil surface cover, landscaping restoration, and erosion control are confirmed for the reviewed scope.',
      'Tree compliance and arborist records are available where required.',
      'Site cleanup is complete and no construction debris remains in exterior areas.',
      'Exterior deficiencies from S14-01 through S14-04 are resolved or formally documented.',
      'Exterior documentation package is ready for S15 final review.',
    ],
    failWhen: [
      'Landscaping or soil surface restoration is materially incomplete for final site closeout.',
      'Required tree compliance sign-off or arborist records are missing where required by AHJ or Vancouver-specific bylaw path.',
      'Construction debris or waste materials remain in exterior areas.',
      'Unresolved exterior deficiencies from S14-01 through S14-04 remain without formal documentation.',
    ],
    pendingWhen: [
      'Final landscaping, soil cover, or arborist sign-off is still in progress and requires a return inspection or document submission.',
      'A minor site-cleanup or exterior deficiency correction is expected before acceptance.',
      'The exterior documentation package is being assembled and is expected shortly.',
    ],
    requiredEvidence: [
      'Inspector-captured field photos showing landscaping and soil cover restoration, erosion control measures, and site cleanup.',
      'Closeout records or field notes confirming tree compliance and arborist record status where required.',
    ],
    optionalEvidence: [
      'Arborist sign-off records or tree compliance confirmation.',
      'Environmental restoration notes or contractor records.',
      'Overview photos documenting site restoration and cleanup.',
    ],
    evidenceMode: 'required_upload',
    permitType: 'building',
    responsibleParty: 'Inspector',
    documentUploadRequired: true,
    ahjNotes: 'Capture local landscaping-restoration, tree-compliance, arborist, environmental-closeout, or site-cleanup requirements that must be confirmed before final occupancy review proceeds. Note that tree arborist sign-off and environmental compliance records are third-party; Vero inspectors confirm receipt and observable conditions only.',
    dependencies: ['S14-04'],
    codeReferences: [
      {
        label: 'BC Building Code 2024 — Division B, Part 9: Site Restoration and Final Site Conditions',
        legalReference: 'BCBC 2024, Division B, Part 9',
      },
      {
        label: 'Vancouver Building By-law 2025 — Division B: Site Restoration and Landscaping Requirements',
        legalReference: 'VBBL 2025, Division B',
        isVbblOnly: true,
      },
      {
        label: 'Vancouver Building By-law 2025 — Division C: Tree Protection, Arborist Compliance, and Site Closeout',
        legalReference: 'VBBL 2025, Division C',
        isVbblOnly: true,
      },
    ],
...
const STRUCTURAL_STAGE_15_CONTAINERS: StructuredStageItemDefinition[] = [
  {
    code: 'S15-01',
    label: 'Life-Safety Systems Final Verification',
    uiSchema: 'field_view',
    purpose: 'Confirm that all life-safety systems observable at the time of final inspection are in place and operable at required locations before the occupancy closeout sequence proceeds.',
    viewDetails: 'Document the final status of smoke alarms, CO alarms, emergency egress openings, exit signage, emergency lighting, guards, handrails, fire separations, and firestopping at reviewed areas. Vero records observable conditions and submitted confirmations. Vero does not certify code compliance or replace fire authority acceptance.',
    stopIf: [
      'Smoke alarm or CO alarm required by permit scope is absent or non-functional at the time of inspection where applicable.',
      'Emergency egress opening is inoperable, blocked, or absent where required by approved drawings.',
    ],
    dependencies: ['S14-05'],
    fieldChecklist: [
      'Smoke alarm installation confirmed at all required locations where applicable to permit scope and occupancy class.',
      'CO alarm installation confirmed where required by fuel-burning appliances, attached garage, or approved drawings.',
      'Emergency egress windows and doors confirmed operable and unobstructed where applicable.',
      'Exit signage installed, illuminated, and visible where required by permit scope or occupancy classification.',
      'Emergency lighting confirmed operational where required by permit scope or occupancy classification.',
      'Guards in place at all elevated surfaces above applicable fall-height threshold where required.',
      'Handrail graspable profile and return ends confirmed where applicable.',
      'Fire separation continuity confirmed at penetrations and wall/ceiling transitions where required.',
      'Firestopping installed at penetrations of fire-rated assemblies where required by fire authority or AHJ.',
    ],
    notesGuidance: 'Record observed life-safety system status at required locations, note any missing or non-functional items, and document fire authority acceptance status where applicable.',
    whatToCheck: [
      'Smoke alarm installation at required sleeping areas, storeys, and common areas where applicable to occupancy class and permit scope.',
      'CO alarm presence at required locations where fuel-burning appliances or attached garage are present.',
      'Emergency egress windows and doors operable, unobstructed, and of required minimum dimensions where applicable.',
      'Exit signage installed and illuminated at required exit routes where required by permit scope or occupancy class.',
      'Emergency lighting operational at required areas where required by permit scope or occupancy class.',
      'Guards in place and at required height at elevated floor areas, landings, decks, and stairways where applicable.',
      'Handrails present, graspable, and continuous with compliant return ends where applicable.',
      'Fire separation assemblies intact and penetrations closed at reviewed areas where required.',
      'Firestopping installed at all penetrations of fire-rated assemblies where required.',
    ],
    passWhen: [
      'All life-safety systems observed and documented are in place and operable at required locations where applicable to the permit scope.',
      'Fire separation and penetration closures are confirmed at reviewed areas where required.',
      'Guards and handrails are confirmed at elevated surfaces where required and no observable life-safety gap remains.',
    ],
    failWhen: [
      'Required smoke alarm or CO alarm is absent or non-functional where applicable.',
      'Emergency egress opening is inoperable, blocked, or absent where required.',
      'Guard or handrail is absent at an elevated surface above the applicable fall-height threshold where required.',
      'A required fire separation or penetration closure is absent or incomplete where required.',
    ],
    pendingWhen: [
      'Life-safety system installation is in progress and not yet available for inspection.',
      'Final fire authority review is scheduled but has not yet been conducted.',
      'A required fire authority confirmation is expected and may resolve the hold.',
    ],
    requiredEvidence: [
      'Photo documentation of smoke alarm and CO alarm installation at required locations where applicable.',
      'Photo documentation of emergency egress openings and guard/handrail conditions at reviewed locations where applicable.',
      'Inspector notes confirming life-safety system status and any observed exceptions.',
    ],
    optionalEvidence: [
      'Smoke and CO alarm product specification sheets.',
      'Fire authority inspection record or acceptance letter where applicable.',
      'Fire separation inspection photos at penetrations and transitions.',
    ],
    evidenceMode: 'required_upload',
    permitType: 'occupancy',
    responsibleParty: 'Inspector',
    documentUploadRequired: true,
    ahjNotes: 'Confirm local smoke alarm, CO alarm, emergency egress, exit signage, emergency lighting, guard, handrail, and fire separation requirements with the AHJ where applicable. Fire authority acceptance may be required separately from building authority sign-off where required by AHJ.',
    codeReferences: [
      { label: 'BC Building Code 2024 — Division B, Part 9: Smoke Alarms, CO Alarms, Egress, Guards, and Handrails for Residential Occupancies where applicable', legalReference: 'BCBC 2024, Division B, Part 9' },
      { label: 'BC Building Code 2024 — Division B, Part 3: Exit Signage, Emergency Lighting, and Fire Separations for Part 3 Occupancies where applicable', legalReference: 'BCBC 2024, Division B, Part 3' },
      { label: 'Vancouver Building By-law 2025 — Division B: Life-Safety System Requirements for Vancouver Occupancies where applicable', legalReference: 'VBBL 2025, Division B', isVbblOnly: true },
    ],
  },
  {
    code: 'S15-02',
    label: 'Prior-Stage Deficiency Resolution and Final Trade Confirmations',
    uiSchema: 'field_view',
    purpose: 'Confirm that all prior inspection stage deficiencies are resolved or formally documented, and that final trade inspection confirmations and utility service connections are on file where required before the professional assurance and occupancy gate sequence proceeds.',
    viewDetails: 'Document the resolution or accepted disposition of prior-stage deficiencies, final plumbing, electrical, and mechanical/gas inspection confirmations, and utility service connection status where required. Vero records documented evidence and inspector-confirmed observations. Vero does not perform trade inspections or certify utility activations.',
    stopIf: [
      'An open life-safety deficiency from a prior inspection stage remains unresolved and no accepted disposition has been documented.',
    ],
    dependencies: ['S15-01'],
    fieldChecklist: [
      'All prior inspection stage deficiencies resolved, formally accepted, or documented with disposition where applicable.',
      'Final plumbing inspection confirmation documented or referenced where applicable to permit scope.',
      'Final electrical inspection confirmation documented or referenced where applicable to permit scope.',
      'Final mechanical/gas inspection confirmation documented or referenced where applicable to permit scope.',
      'Utility service connections confirmed active or documented where required by permit scope.',
      'Third-party utility or service authority confirmation on file where required by AHJ or utility authority.',
    ],
    notesGuidance: 'Record the status of all prior-stage deficiencies, final trade inspections, and utility confirmations. Note any unresolved items and their current disposition.',
    whatToCheck: [
      'Prior inspection stage records reviewed for any outstanding deficiencies or open holds.',
      'Each deficiency either resolved and documented, formally accepted by AHJ, or documented with a clear AHJ-accepted disposition.',
      'Final plumbing inspection confirmation available in the record where the project includes a plumbing permit.',
      'Final electrical inspection confirmation available in the record where the project includes an electrical permit.',
      'Final mechanical or gas inspection confirmation available in the record where the project includes a mechanical or gas permit.',
      'Utility service connections confirmed active or documented where required by permit scope and AHJ.',
    ],
    passWhen: [
      'All prior inspection stage deficiencies are resolved, formally accepted, or documented with AHJ-accepted disposition where applicable.',
      'Final trade inspection confirmations are on file where required by permit scope.',
      'Utility service connections are confirmed active or documented where required.',
    ],
    failWhen: [
      'An outstanding life-safety deficiency from a prior stage remains unresolved without accepted disposition.',
      'A required final trade inspection confirmation is missing or not available in the record.',
      'A required utility service connection is unconfirmed or undocumented where required by permit scope.',
    ],
    pendingWhen: [
      'Final trade inspection is scheduled but has not yet been conducted or documented.',
      'A utility confirmation is expected from a service authority and may resolve the hold.',
      'A prior-stage deficiency is under active resolution with documented progress.',
    ],
    requiredEvidence: [
      'Inspector notes or sign-off records documenting the resolution or accepted disposition of prior-stage deficiencies where applicable.',
      'Final trade inspection confirmation documents where applicable to permit scope.',
    ],
    optionalEvidence: [
      'Utility service activation or connection confirmation correspondence.',
      'Trade inspection sign-off letters or third-party confirmation records.',
      'Deficiency resolution photographs or written resolution summary.',
    ],
    evidenceMode: 'required_upload',
    permitType: 'occupancy',
    responsibleParty: 'Inspector',
    documentUploadRequired: true,
    ahjNotes: 'Confirm local requirements for prior-stage deficiency resolution, final trade inspection documentation, and utility service confirmation with the AHJ where applicable. Some jurisdictions require written AHJ acceptance of deficiency dispositions before the occupancy gate can proceed.',
    codeReferences: [
      { label: 'BC Building Code 2024 — Division B, Part 9: Final Inspection Readiness and Administrative Closeout for Residential Occupancies', legalReference: 'BCBC 2024, Division B, Part 9' },
      { label: 'BC Building Code 2024 — Division B, Part 3: Final Inspection and Occupancy Readiness for Part 3 Occupancies where applicable', legalReference: 'BCBC 2024, Division B, Part 3' },
      { label: 'Vancouver Building By-law 2025 — Division B: Final Inspection and Deficiency Resolution Requirements for Vancouver Occupancies where applicable', legalReference: 'VBBL 2025, Division B', isVbblOnly: true },
    ],
  },
  {
    code: 'S15-03',
    label: 'Professional Assurance, Closeout Documents, and Final Vero Evidence Package',
    uiSchema: 'field_view',
    purpose: 'Confirm that required professional assurance documents, closeout records, and the final Vero inspection evidence package are on file and complete before the AHJ final approval documentation sequence proceeds.',
    viewDetails: 'Document the submission and acceptance status of Letters of Assurance, Schedule B and Schedule C-B professional assurance schedules, as-built drawings, test reports, commissioning records, warranties, and the final Vero inspection evidence package. Vero records submission evidence. Vero does not certify professional assurance documents or replace registered professional sign-off.',
    stopIf: [
      'Required Letters of Assurance or Schedule C-B are missing and the permit scope mandates professional assurance for occupancy where applicable.',
    ],
    dependencies: ['S15-02'],
    fieldChecklist: [
      'Letters of Assurance received and on file where permit scope requires professional assurance.',
      'Schedule B and Schedule C-B submitted and accepted where required by permit scope or AHJ.',
      'As-built drawings submitted and on file where required by AHJ or approved drawings.',
      'Test reports on file where applicable, including structural, plumbing, electrical, gas, mechanical, or building envelope reports as required by permit scope.',
      'Commissioning documents or equipment warranties on file where required by permit scope or AHJ.',
      'Final Vero inspection record package complete and available for occupancy review where applicable.',
    ],
    notesGuidance: 'Record the submission and acceptance status of professional assurance documents, as-built drawings, test reports, and the final Vero evidence package. Note any outstanding items and their expected resolution.',
    whatToCheck: [
      'Letters of Assurance received from each required registered professional where permit scope requires professional assurance.',
      'Schedule B and Schedule C-B submitted and on file where required by the permit or AHJ.',
      'As-built drawings submitted and on file where required by AHJ conditions or approved permit terms.',
      'Applicable test reports on file covering structural, plumbing, electrical, gas, mechanical, or building envelope testing as required by permit scope.',
      'Commissioning documents and equipment warranties on file where required by permit scope or AHJ.',
      'Final Vero inspection record package assembled and complete for occupancy review purposes.',
    ],
    passWhen: [
      'Required Letters of Assurance and professional assurance schedules are submitted and on file where required by permit scope.',
      'Required as-built drawings and test reports are submitted and on file where required.',
      'Commissioning documents and warranties are on file where required by permit scope.',
      'Final Vero inspection record package is complete and available for occupancy review.',
    ],
    failWhen: [
      'Required Letters of Assurance or Schedule C-B are missing where professional assurance is mandated by permit scope.',
      'Required as-built drawings are missing where required by AHJ or approved drawings.',
      'Required test reports are absent where the permit scope requires documented testing.',
    ],
    pendingWhen: [
      'A required professional assurance document is in preparation and expected to be submitted shortly.',
      'As-built drawing preparation is in progress and may clear the hold.',
      'A test report is being finalized and may be submitted to complete the record.',
    ],
    requiredEvidence: [
      'Letters of Assurance and professional assurance schedules where required by permit scope.',
      'Schedule B and Schedule C-B submission records where applicable.',
      'Completed Vero inspection evidence package confirming final record completeness.',
    ],
    optionalEvidence: [
      'As-built drawing submission confirmation.',
      'Test report file copies where applicable.',
      'Equipment commissioning records and warranty documents where applicable.',
      'Consultant closeout correspondence.',
    ],
    evidenceMode: 'required_upload',
    permitType: 'occupancy',
    responsibleParty: 'Inspector',
    documentUploadRequired: true,
    ahjNotes: 'Confirm local professional assurance, Letters of Assurance, as-built, and test report submission requirements with the AHJ where applicable. Schedule B and Schedule C-B requirements are determined by the registered professional and building permit conditions. Vero records submission evidence but does not certify professional assurance documents.',
    codeReferences: [
      { label: 'BC Building Code 2024 — Division C, Part 2: Professional Assurance, Letters of Assurance, Schedule B, and Schedule C-B Administrative Closeout', legalReference: 'BCBC 2024, Division C, Part 2' },
      { label: 'BC Building Code 2024 — Division B, Part 9: Administrative Closeout Requirements for Residential Construction', legalReference: 'BCBC 2024, Division B, Part 9' },
      { label: 'Vancouver Building By-law 2025 — Division C: Professional Assurance, Permit Closeout, and Occupancy Documentation for Vancouver Permits', legalReference: 'VBBL 2025, Division C', isVbblOnly: true },
    ],
  },
  {
    code: 'S15-04',
    label: 'AHJ Final Approval Status and Occupancy Permit Documentation',
    uiSchema: 'field_view',
    purpose: 'Document AHJ final inspection status, occupancy permit issuance or final acceptance reference, and the formal closure of the Vero inspection record.',
    viewDetails: 'Record the AHJ final inspection status, occupancy permit number or final acceptance reference, any outstanding AHJ conditions, and the Vero record closure confirmation. Vero documents AHJ approval evidence. Vero does not issue occupancy, grant final approval, certify code compliance, or replace AHJ authority.',
    stopIf: [
      'An AHJ-issued hold blocking occupancy is confirmed outstanding and unresolved at the time of final Vero record closure.',
    ],
    dependencies: ['S15-03'],
    fieldChecklist: [
      'AHJ final inspection status documented as accepted, conditional acceptance, hold, or other AHJ-issued status where applicable.',
      'No outstanding AHJ-issued hold preventing occupancy remains unresolved where applicable to this permit.',
      'Occupancy permit number or final acceptance reference documented where issued by the AHJ or municipal authority.',
      'Final municipal or AHJ correspondence uploaded where required to complete the Vero closeout record.',
      'Vero inspection record formally closed and final evidence package confirmed complete.',
    ],
    notesGuidance: 'Record the AHJ final inspection status, occupancy permit issuance reference, any outstanding conditions, and the Vero record closure confirmation. Note that Vero documents AHJ status — Vero does not issue occupancy or grant approval.',
    whatToCheck: [
      'AHJ final inspection status confirmed and documented from available records where applicable.',
      'No outstanding AHJ-issued hold preventing occupancy remains unresolved.',
      'Occupancy permit or final acceptance reference documented where issued by the municipal or AHJ authority.',
      'Final municipal or AHJ correspondence available and uploaded to the Vero record where required.',
      'Vero inspection record is complete, closed, and the evidence package is assembled for final reliance.',
    ],
    passWhen: [
      'AHJ final inspection has been accepted or conditionally accepted where applicable and the status is documented in the Vero record.',
      'No outstanding AHJ-issued hold preventing occupancy is documented as unresolved.',
      'Occupancy permit or final acceptance reference is on file where issued by the AHJ.',
      'Final Vero inspection evidence package is complete and the record is closed.',
    ],
    failWhen: [
      'An AHJ-issued hold blocking occupancy is confirmed outstanding and unresolved.',
      'Final AHJ inspection has been conducted and resulted in a formal rejection or non-acceptance.',
      'Occupancy permit has been withheld by the AHJ and no resolution pathway is documented.',
    ],
    pendingWhen: [
      'AHJ final inspection is scheduled but has not yet been conducted.',
      'An administrative occupancy permit issuance step is underway and may resolve the hold shortly.',
      'A conditional acceptance has been issued and the remaining AHJ conditions are under active resolution.',
    ],
    requiredEvidence: [
      'Inspector notes documenting AHJ final inspection status and occupancy permit issuance or acceptance reference where applicable.',
      'Final Vero inspection evidence package confirming record closure.',
    ],
    optionalEvidence: [
      'AHJ-issued occupancy permit copy or final acceptance letter where obtained.',
      'Final municipal correspondence or approval notification.',
      'Conditional acceptance letter and disposition notes where applicable.',
    ],
    evidenceMode: 'required_upload',
    permitType: 'occupancy',
    responsibleParty: 'Inspector',
    documentUploadRequired: true,
    ahjNotes: 'Vero documents and records occupancy permit status and AHJ approval evidence. Vero does not issue occupancy, certify code compliance, or replace AHJ authority. The occupancy permit or final acceptance is issued solely by the AHJ or municipal authority.',
    codeReferences: [
      { label: 'BC Building Code 2024 — Division C, Part 2: Occupancy, Final Authority Approval, and Building Permit Closeout', legalReference: 'BCBC 2024, Division C, Part 2' },
      { label: 'BC Building Code 2024 — Division B, Part 9: Occupancy Requirements for Residential Buildings', legalReference: 'BCBC 2024, Division B, Part 9' },
      { label: 'Vancouver Building By-law 2025 — Division B: Occupancy Permit Conditions and Requirements for Vancouver Permits', legalReference: 'VBBL 2025, Division B', isVbblOnly: true },
    ],
  },
]
