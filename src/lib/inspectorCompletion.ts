...
const STRUCTURAL_STAGE_6_CONTAINERS: StructuredStageItemDefinition[] = [
  ...
  },
  {
    ...
    viewDetails: 'Ensure all secondary structural elements, stair rough openings, fire separation framing conditions in multi-unit buildings, and specialty engineering components are reviewable before concealment. Verify stair framing, headroom clearance, guard and fall-protection blocking readiness, deck and balcony framing and ledger connections, fire blocking and fire separation framing conditions where applicable, and the presence of Part 4 engineering documentation where the project exceeds Part 9 limits.',
    stopIf: [
    ...
    fieldChecklist: [
      ...
      'Guard and fall-protection blocking or backing installed where stair, balcony, or landing guards are required where applicable?',
      ...
      'Part 4 engineering reports or supporting documents available where project exceeds Part 9 limits? (If within Part 9 limits, mark as Pass or N/A)',
    ],
    ...
    whatToCheck: [
      ...
      'Guard and fall-protection backing or blocking is visible at stair, balcony, and landing guard locations where required.',
    ...
    failWhen: [
      ...
      'Guard backing or fall-protection blocking is absent where required by the reviewed scope.',
    ...
    permitType: 'building',
    responsibleParty: 'Inspector',
    requiredLogic: 'Conditional: Part 4 engineering documentation is required when the project exceeds Part 9 limits or includes engineered specialty structural elements. Fire separation framing applies in multi-unit buildings and where required by the approved drawings.',
    documentUploadRequired: true,
...
const STRUCTURAL_STAGE_7_CONTAINERS: StructuredStageItemDefinition[] = [
  ...
  },
  {
    ...
    viewDetails: 'Validate that required building-envelope field review letters or reports are available, scheduled, or identified where professional involvement is required. Confirm manufacturer representative observations, AHJ envelope conditions, and special inspection requirements are addressed. Ensure any envelope deficiencies, open field review items, or missing assurance documentation are listed and resolved before cladding or concealment proceeds.',
    stopIf: [
    ...
    permitType: 'building',
    responsibleParty: 'Inspector',
    requiredLogic: 'Conditional: building-envelope field review is required where the permit scope, AHJ, or approved drawings trigger professional involvement.',
    documentUploadRequired: true,
    ...
    codeReferences: [
      {
        label: 'BC Building Code 2024 — Building Envelope Performance and Professional Involvement',
        legalReference: 'BCBC 2024 Division C, Part 2 (Qualifications of Designers and Certified Professionals)',
        sourceTitle: 'British Columbia Building Code 2024',
        sourceUrl: null,
      },
      {
        label: 'BC Building Code 2024 — Rain Penetration Control and Moisture Management',
        legalReference: 'BCBC 2024 Division B, Part 9, Section 9.27 (Rain Penetration Control)',
        sourceTitle: 'British Columbia Building Code 2024',
        sourceUrl: null,
      },
    ],
...
const STRUCTURAL_STAGE_8_CONTAINERS: StructuredStageItemDefinition[] = [
  {
    ...
    codeReferences: [
      {
        label: 'BC Building Code 2024 — Fire Separation Requirements',
        legalReference: 'BCBC 2024 Division B, Part 9, Section 9.10 (Fire Protection)',
        sourceTitle: 'British Columbia Building Code 2024',
        sourceUrl: null,
      },
      {
        label: 'BC Building Code 2024 — Firestopping of Penetrations',
        legalReference: 'BCBC 2024 Division B, Part 3, Section 3.1.9 (Fire Stops)',
        sourceTitle: 'British Columbia Building Code 2024',
        sourceUrl: null,
      },
    ],
  ...
  {
    code: 'S08-02',
    label: 'Egress, Alarms, and Emergency Lighting',
    uiSchema: 'field_view',
    ...
    codeReferences: [
      {
        label: 'BC Building Code 2024 — Means of Egress',
        legalReference: 'BCBC 2024 Division B, Part 9, Section 9.9 (Means of Egress)',
        sourceTitle: 'British Columbia Building Code 2024',
        sourceUrl: null,
      },
      {
        label: 'BC Building Code 2024 — Smoke Alarms and Carbon Monoxide Alarms',
        legalReference: 'BCBC 2024 Division B, Part 9, Section 9.10.19 (Smoke Alarms) and Section 9.10.20 (Carbon Monoxide Alarms)',
        sourceTitle: 'British Columbia Building Code 2024',
        sourceUrl: null,
      },
    ],
  ...
  },
  {
    ...
    codeReferences: [
      {
        label: 'BC Building Code 2024 — Guards and Handrails',
        legalReference: 'BCBC 2024 Division B, Part 9, Section 9.8.8 (Guards)',
        sourceTitle: 'British Columbia Building Code 2024',
        sourceUrl: null,
      },
      {
        label: 'BC Building Code 2024 — Adaptable Housing Features',
        legalReference: 'BCBC 2024 Division B, Part 9, Section 9.5 (Adaptable Dwelling Units)',
        sourceTitle: 'British Columbia Building Code 2024',
        sourceUrl: null,
      },
    ],
  ...
  },
  {
    ...
    stopIf: [
      'Applicability of fire suppression is unresolved and cladding or concealment is about to proceed without confirmation.',
    ...
    whatToCheck: [
      ...
      'If applicability is unclear, the item must Hold for AHJ or qualified professional confirmation before cladding or concealment proceeds.',
    ...
    codeReferences: [
      {
        label: 'BC Building Code 2024 — Sprinkler System Requirements',
        legalReference: 'BCBC 2024 Division B, Part 3, Section 3.2.5 (Sprinkler Systems) — where applicable by occupancy or building type',
        sourceTitle: 'British Columbia Building Code 2024',
        sourceUrl: null,
      },
      {
        label: 'NFPA 13 — Installation of Sprinkler Systems',
        legalReference: 'NFPA 13 (as adopted by the AHJ) — where NFPA 13 pathway is applicable',
        sourceTitle: 'National Fire Protection Association NFPA 13',
        sourceUrl: null,
      },
      {
        label: 'NFPA 13R — Sprinklers in Residential Occupancies up to and including Four Stories',
        legalReference: 'NFPA 13R (as adopted by the AHJ) — where NFPA 13R pathway is applicable',
        sourceTitle: 'National Fire Protection Association NFPA 13R',
        sourceUrl: null,
      },
      {
        label: 'NFPA 13D — Sprinklers in One- and Two-Family Dwellings',
        legalReference: 'NFPA 13D (as adopted by the AHJ) — where NFPA 13D pathway is applicable',
        sourceTitle: 'National Fire Protection Association NFPA 13D',
        sourceUrl: null,
      },
    ],
    dependencies: ['S08-03'],
  },
  {
    ...
    codeReferences: [
      {
        label: 'BC Building Code 2024 — Fire Alarm System Requirements',
        legalReference: 'BCBC 2024 Division B, Part 3, Section 3.2.4 (Fire Alarm and Detection Systems) — where applicable by occupancy or building type',
        sourceTitle: 'British Columbia Building Code 2024',
        sourceUrl: null,
      },
      {
        label: 'ULC S524 — Installation of Fire Alarm Systems (Referenced Standard under BCBC)',
        legalReference: 'ULC S524 (Referenced Standard under BCBC 2024) — where fire alarm system is applicable',
        sourceTitle: 'Underwriters Laboratories of Canada ULC S524',
        sourceUrl: null,
      },
    ],
    dependencies: ['S08-04'],
