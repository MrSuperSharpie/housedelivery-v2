...
export default function DispatchPage() {
  ...
  const [selectedSpecialistRole] = useState<SpecialistRoleId | null>(null)
  const [billableHours] = useState(1.5)
  const holdHours = 0
        ...
        <div className="bg-blue-50 border border-blue-100 rounded-2xl p-4 mb-5">
          ...
          <div className="mt-2 flex items-end justify-between gap-3">
            <div>
              ...
              <div className="text-2xl font-black text-slate-900">{formatCurrency(pricingBreakdown.builderEscrowTotal)}</div>
            </div>
          ...
          <div className="mb-5">
            ...
            <div className="bg-white rounded-2xl border border-gray-100 p-4 mb-4 space-y-2 text-sm">
              ...
              <div className="flex justify-between border-t border-gray-100 pt-2">
                ...
                <span className="font-black text-slate-900">{formatCurrency(pricingBreakdown.builderEscrowTotal)}</span>
              </div>
            </div>
            <Button
              variant="primary"
