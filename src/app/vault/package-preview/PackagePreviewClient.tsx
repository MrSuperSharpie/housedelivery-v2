      ...
      <div className="max-w-4xl mx-auto px-4 py-6 print:py-2">
        ...
        <div className="siteline-print-header hidden">
          <div className="flex items-center justify-between">
            <div>
              <div style={{ fontWeight: 900, fontSize: '14pt', letterSpacing: '0.02em' }}>SiteLine</div>
              <div style={{ fontSize: '8pt', color: '#555555', marginTop: '2pt' }}>
                Inspection Compliance Platform · siteline.ca
              </div>
            </div>
        ...
        <div className="siteline-print-footer hidden">
          SiteLine Field Inspection Report
        ...
        <div className="siteline-print-cover hidden">
          ...
          <div style={{ marginBottom: '32pt' }}>
            <div style={{ fontWeight: 900, fontSize: '22pt', letterSpacing: '0.03em' }}>SiteLine</div>
          ...
          <div style={{ fontSize: '18pt', fontWeight: 900, marginBottom: '6pt' }}>
            SiteLine Stage Inspection Record
          </div>
          ...
          <div style={{ marginTop: '32pt', fontSize: '8pt', color: '#888888', maxWidth: '320pt', lineHeight: '1.5' }}>
            This package was generated by SiteLine and sealed by the inspector of record. It is not an official submission until received and accepted by the relevant authority having jurisdiction.
          </div>
        </div>
        ...
        <section className="card-dark rounded-2xl p-5 mb-4 print:border print:rounded-lg">
          ...
          <div className="grid gap-3 text-sm">
            ...
            <div className="flex gap-3">
              ...
              <span className="text-ink">SiteLine Verified</span>
            </div>
