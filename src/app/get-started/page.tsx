...
const ROLES = [
  {
    ...
    perks: [
      ...
      'Review inspector applicants and choose your CP',
      'Live tracker when inspector is en route',
  ...
  },
  {
    ...
    Icon:        Eye,
    label:       'City Auditor',
    tagline:     'Access the public inspection vault',
    ...
    perks: [
      'Read-only access to all sealed inspection records',
      'Filter by project, date, inspector, or jurisdiction',
      'Download Schedule C-B letters and evidence packages',
      'Record integrity and audit trail for archives',
      'Integrated with municipal permit management systems',
    ],
  },
]
