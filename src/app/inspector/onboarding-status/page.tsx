    ...
    <div className="min-h-screen bg-[#0A192F] flex flex-col">
      <div className="border-b border-blue-900 px-4 py-4">
        <div className="max-w-xl mx-auto flex items-center justify-between">
          ...
          {user?.role === 'inspector' ? (
            ...
            <Link href="/sign-in?role=inspector" className="text-xs text-[#C6A15B] font-semibold hover:underline">
              Sign in
            </Link>
          )}
        </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-4 py-12 max-w-md mx-auto">
        ...
        <div className="bg-[#0d2137] border border-blue-900 rounded-2xl p-5 w-full text-left mb-8">
          ...
          <ul className="space-y-2.5 text-sm text-blue-300">
            <li className="flex items-start gap-2">
              <span className="text-[#C6A15B] font-bold shrink-0">1.</span>
              Vero reviews your credentials and documents first (not the builder).
            </li>
            <li className="flex items-start gap-2">
              <span className="text-[#C6A15B] font-bold shrink-0">2.</span>
              Once approved, you get access to the Live Board and can apply to jobs.
            </li>
            <li className="flex items-start gap-2">
              <span className="text-[#C6A15B] font-bold shrink-0">3.</span>
        ...
        {status === 'approved' ? (
          <Link
            href="/inspector"
            className="w-full flex items-center justify-center gap-2 bg-[#C6A15B] text-[#1B1508] font-bold py-4 rounded-xl hover:opacity-90 transition-opacity"
          >
