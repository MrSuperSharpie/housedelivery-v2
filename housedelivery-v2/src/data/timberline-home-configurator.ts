...
const assetRoot = "/images/homes/timberline/visual-guide";
...
const coastalPackageDirections = [
  {
    level: "premium",
    optionNumber: "1",
...
const alpinePackageDirections = [
  {
    level: "premium",
    optionNumber: "1",
    name: "Warm Natural Oak",
    filenameLabel: "Warm-Natural-Oak",
    descriptors: ["Warm", "Natural", "Tactile"],
    storyFragments: ["warm natural oak", "a calm, tactile material palette"],
  },
  {
    level: "premium",
    optionNumber: "2",
    name: "Tailored Light",
    filenameLabel: "Tailored-Light",
    descriptors: ["Tailored", "Light", "Refined"],
    storyFragments: ["tailored light finishes", "quietly refined detailing"],
  },
  {
    level: "signature",
    optionNumber: "1",
    name: "Smoked Oak Charcoal",
    filenameLabel: "Smoked-Oak-Charcoal",
    descriptors: ["Smoked", "Charcoal", "Architectural"],
    storyFragments: ["smoked oak", "disciplined charcoal accents"],
  },
  {
    level: "signature",
    optionNumber: "2",
    name: "Limestone Bronze",
    filenameLabel: "Limestone-Bronze",
    descriptors: ["Mineral", "Bronze", "Composed"],
    storyFragments: ["honed limestone", "warm bronze detailing"],
  },
] as const satisfies readonly PackageSource[];

const windowPackageDirections = [
  {
    ...alpinePackageDirections[0],
    name: "Warm Natural",
    filenameLabel: "Warm-Natural",
  },
  alpinePackageDirections[1],
  {
    ...alpinePackageDirections[2],
    name: "Charcoal Smoked Oak",
    filenameLabel: "Charcoal-Smoked-Oak",
  },
  alpinePackageDirections[3],
] as const satisfies readonly PackageSource[];
...
function createOption(
  ...
  return {
    ...
    image: {
      ...
      alt: `${source.level === "premium" ? "Premium" : "Signature"} ${source.optionNumber} — ${source.name}, ${chapter.title.toLowerCase()} design board for Timberline House.`,
      fit: "contain",
      role: "design-board",
      quality: 100,
    },
...
const chapters = [
  createChapter({
    ...
    shortTitle: "Kitchen",
    assetPrefix: "Timberline_01_Kitchen",
    description:
      "Choose one coordinated kitchen package. Its complete design board carries the finish direction into My Timberline.",
    represents: [
      "Cabinetry",
    ...
    options: coastalPackageDirections,
  }),
  createChapter({
    ...
    assetPrefix: "Timberline_02_Primary-Ensuite",
    description:
  ...
  createChapter({
    ...
    assetPrefix: "Timberline_03_Primary-Wardrobe",
    description:
      "Choose the coordinated wardrobe package for the Timberline primary suite.",
    represents: [
      "Cabinet finish",
      "Door treatment",
      "Interior finish",
    ...
    options: alpinePackageDirections,
  }),
  createChapter({
    ...
    assetPrefix: "Timberline_04_Interior-Doors-Details",
    description:
  ...
  createChapter({
    ...
    assetPrefix: "Timberline_05_Exterior-Arrival-Openings",
    description:
      "Choose a coordinated exterior finish direction for Timberline's arrival and openings.",
    represents: [
      "Entry door",
    ...
    technicalNote:
      "This selection changes finishes and appearance only. The Timberline footprint, roof geometry, window placement and architectural massing remain unchanged.",
    options: coastalPackageDirections,
  }),
  createChapter({
    ...
    assetPrefix: "Timberline_06_Whole-Home-Flooring-Stairs",
    description:
      "Choose one coordinated flooring and stair package for Timberline's dry interior areas.",
    represents: [
      "Main living areas",
      "Bedrooms",
      "Stair treads",
  ...
  createChapter({
    ...
    assetPrefix: "Timberline_07_Window-Coverings",
    description:
    ...
    options: windowPackageDirections,
  }),
] as const;
...
const timberlineModel = models.find((model) => model.slug === "timberline");

if (!timberlineModel) {
  throw new Error("Timberline configurator source data is unavailable.");
}

export const timberlineHomeConfigurator: HomeConfiguratorDefinition = {
  configurationVersion: 4,
  homeId: timberlineModel.slug,
  homeName: "Timberline",
  residenceLabel: "Timberline House",
  architecturalImages: [
    {
      src: timberlineModel.heroImage,
      alt: "Timberline House exterior architecture.",
    },
    {
      src: timberlineModel.images[1],
      alt: "Timberline House architectural living space.",
    },
  ],
  disclaimer:
  ...
  lookBook: {
    home: {
      id: timberlineModel.slug,
      name: "Timberline",
      residenceLabel: "Timberline House",
      areaLabel: `${timberlineModel.squareFeet.toLocaleString()} sq. ft.`,
      description: timberlineModel.description,
      heroImage: {
        src: timberlineModel.heroImage,
        alt: "Timberline House exterior architecture.",
      },
      ...
      metadata: [
        {
          label: "Area",
          value: `${timberlineModel.squareFeet.toLocaleString()} sq. ft.`,
        },
        { label: "Storeys", value: String(timberlineModel.storeys) },
        { label: "Bedrooms", value: String(timberlineModel.bedrooms) },
        { label: "Bathrooms", value: String(timberlineModel.bathrooms) },
      ],
    },
    sections: [
      {
        ...
        id: "design-story",
        number: "01",
        title: "The Timberline You Created",
        introduction:
          "Seven coordinated packages form one considered architectural finish story for Timberline House.",
      ...
      },
      {
        ...
        title: "Exterior Arrival & Openings",
        introduction:
          "A coordinated finish expression applied to Timberline's fixed architectural form, openings and arrival sequence.",
        items: [
    ...
    nextStageSteps: [
      {
        ...
        description:
          "We review the seven selected packages alongside the Timberline home and project requirements.",
      },
      {
