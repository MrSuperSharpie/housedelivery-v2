...
const assetRoot = "/images/homes/langley/visual-guide";
...
const packageDirections = [
  {
    level: "premium",
    optionNumber: "1",
    name: "Hearthstone Oak",
    filenameLabel: "Hearthstone-Oak",
    descriptors: ["Hearthstone", "Natural", "Warm"],
    storyFragments: ["hearthstone oak", "a warm, naturally layered palette"],
  },
  {
    level: "premium",
    optionNumber: "2",
    name: "Gable Linen",
    filenameLabel: "Gable-Linen",
    descriptors: ["Gable", "Linen", "Soft"],
    storyFragments: ["soft neutral surfaces", "soft linen texture"],
  },
  {
    level: "signature",
    optionNumber: "1",
    name: "Manor Graphite",
    filenameLabel: "Manor-Graphite",
    descriptors: ["Manor", "Graphite", "Architectural"],
    storyFragments: ["manor graphite contrast", "a defined architectural frame"],
  },
  {
    level: "signature",
    optionNumber: "2",
    name: "Estate Bronze",
    filenameLabel: "Estate-Bronze",
    descriptors: ["Estate", "Bronze", "Polished"],
    storyFragments: ["quiet estate tones", "polished bronze detailing"],
  },
...
function createOption(
  ...
  return {
    ...
    image: {
      ...
      alt: `${levelLabel} ${source.optionNumber} — ${source.name}, ${chapter.title.toLowerCase()} design board for Langley House.`,
      fit: "contain",
      role: "design-board",
      quality: 100,
    },
...
const chapters = [
  createChapter({
    ...
    shortTitle: "Kitchen",
    assetPrefix: "Langley_01_Kitchen",
    description:
      "Choose one coordinated kitchen package. Its complete design board carries the finish direction into My Langley.",
    represents: [
      "Cabinetry",
  ...
  createChapter({
    ...
    assetPrefix: "Langley_02_Primary-Ensuite",
    description:
  ...
  createChapter({
    ...
    assetPrefix: "Langley_03_Primary-Wardrobe",
    description:
      "Choose one coordinated wardrobe package for the Langley primary suite.",
    represents: [
      "Cabinet finish",
      "Door treatment",
      "Interior finish",
  ...
  createChapter({
    ...
    assetPrefix: "Langley_04_Interior-Doors-Details",
    description:
  ...
  createChapter({
    ...
    assetPrefix: "Langley_05_Exterior-Arrival-Openings",
    description:
      "Choose one coordinated exterior finish direction for Langley's arrival and openings.",
    represents: [
      "Entry door",
    ...
    technicalNote:
      "This selection changes finishes and appearance only. The Langley footprint, roof geometry, window placement and architectural massing remain unchanged.",
  }),
  createChapter({
    ...
    assetPrefix: "Langley_06_Whole-Home-Flooring-Stairs",
    description:
      "Choose one coordinated flooring and stair package for Langley's dry interior areas.",
    represents: [
      "Main living areas",
      "Bedrooms",
      "Stair treads",
  ...
  createChapter({
    ...
    assetPrefix: "Langley_07_Window-Coverings",
    description:
...
const selectionSections = [
  ...
  },
  {
    ...
    title: "Exterior Arrival & Openings",
    introduction:
      "A coordinated finish expression applied to Langley's fixed architectural form, openings and arrival sequence.",
    items: [
...
const langleyModel = models.find((model) => model.slug === "langley");

if (!langleyModel) {
  throw new Error("Langley configurator source data is unavailable.");
}

export const langleyHomeConfigurator: HomeConfiguratorDefinition = {
  configurationVersion: 4,
  homeId: langleyModel.slug,
  homeName: "Langley",
  residenceLabel: "Langley House",
  architecturalImages: [
    {
      src: langleyModel.heroImage,
      alt: "Langley House exterior architecture.",
    },
    {
      src: langleyModel.images[1],
      alt: "Langley House architectural living space.",
    },
  ],
  disclaimer:
  ...
  lookBook: {
    home: {
      id: langleyModel.slug,
      name: "Langley",
      residenceLabel: "Langley House",
      areaLabel: `${langleyModel.squareFeet.toLocaleString()} sq. ft.`,
      description: langleyModel.description,
      heroImage: {
        src: langleyModel.heroImage,
        alt: "Langley House exterior architecture.",
      },
      ...
      metadata: [
        {
          label: "Area",
          value: `${langleyModel.squareFeet.toLocaleString()} sq. ft.`,
        },
        { label: "Storeys", value: String(langleyModel.storeys) },
        { label: "Bedrooms", value: String(langleyModel.bedrooms) },
        { label: "Bathrooms", value: String(langleyModel.bathrooms) },
      ],
    },
    sections: [
      {
        ...
        id: "design-story",
        number: "01",
        title: "The Langley You Created",
        introduction:
          "Seven coordinated packages form one considered architectural finish story for Langley House.",
    ...
    nextStageSteps: [
      {
        ...
        description:
          "We review the seven selected packages alongside the Langley home and project requirements.",
      },
      {
