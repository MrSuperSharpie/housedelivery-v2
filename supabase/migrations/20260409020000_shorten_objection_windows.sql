-- Shorten builder objection windows to preserve instant-dispatch momentum.
--
-- Previous values:  emergency=2h, priority=12h, standard=24h
-- New values:       emergency=30m, priority=1h,  standard=24h (unchanged)
...
begin
  ...
  -- Objection windows (shortened for instant-dispatch UX)
  ...
  -- standard tier keeps the default 24-hour window declared above
